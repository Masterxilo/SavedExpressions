...
levelspec], levelspec as in Replace, defaults to 0\"", ",", 
      ...
      System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"FixedPointReplaceRepeated", "[", 
      ...
      System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"FixedPointReplaceRepeated", "[", 
            ...
            "]"}], ",", System`RowBox[{"FixedPointReplaceRepeated", "[", 
            System`RowBox[{System`RowBox[{"FixedPointReplace", "[", 
  ...
  {{3.680611769959983*^9, 3.680611853724475*^9}, {3.680695070218337*^9, 
   3.680695087613042*^9}, {3.6811189013355722*^9, 3.6811191602799883*^9}, 
   {3.681119367887768*^9, 3.6811193679658947*^9}, {3.6811194923713303*^9, 
   3.681119492452733*^9}, {3.6815338844449134*^9, 3.6815340125090666*^9}, 
   3.681641741791333*^9, {3.681641779436329*^9, 3.681641779438331*^9}}, 
