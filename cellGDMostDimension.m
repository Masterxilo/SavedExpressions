System`Cell[System`BoxData[System`RowBox[
   {System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
      System`RowBox[{System`RowBox[{"GDMostDimension", "[", "g_GridData", 
          "]"}], "\n", "  ", ",", "\"{position, x0} -> {position}\"", "\n", 
        "  ", ",", System`RowBox[{"GDMapPositions", "[", 
          System`RowBox[{"Most", ",", " ", "g"}], "]"}]}], "\n", "]"}], 
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6815682608556404*^9, 3.681568263299692*^9}, {3.681568309008765*^9, 
   ...
   3.6815735943078794*^9}, {3.681573675570326*^9, 3.681573834020134*^9}, 
   3.6816488689673324*^9}]
