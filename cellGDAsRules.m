  ...
  {System`RowBox[{System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
       System`RowBox[{System`RowBox[{"GDAsRules", "[", System`RowBox[
            {"GridData", "[", System`RowBox[{"dataNames_List", ",", " ", 
               "f_FiniteMapping"}], "]"}], "]"}], "\n", ",", "\"Representatio\
n in the format expected by GridDataMakeFromRules\n\nNote that this loses \
dataNames\"", "\n", ",", System`RowBox[{"FMAsRules", "@", "f"}]}], "\n", 
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6815682608556404*^9, 3.681568263299692*^9}, {3.681568309008765*^9, 
   ...
   {3.681574105049485*^9, 3.6815741798308415*^9}, 3.681577647595971*^9, 
   3.6816352939558535*^9}, System`CellTags -> 
  "depersistedCell1bd0fa65-664a-45a6-9920-258b2df4ec1c"]
