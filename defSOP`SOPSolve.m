System`HoldComplete[Global`NeedsDefined[System`CompoundExpression, 
   ...
   Global`StackWithoutContexts, System`List, System`Assert, System`False, 
   System`Stack, System`OptionValue, System`Method, System`MaxIterations, 
   System`Alternatives, System`$Failed, System`Set, System`Options, 
   System`Rule, PackageDeveloper`DefinePublicFunction, System`FindMinimum, 
   ...
   System`Apply, SOP`SOPYData, System`Null, System`Throw, System`SameQ, 
   System`Keys, SOP`SOPGetY, SOP`SparseOptimizationProblemMakeWithUpdatedY, 
   System`Values, numerics`ApproximatelyEqual, SOP`SOPEnergy, 
   SOPCompiled`finalEnergy, SOP`y1, LocalGaussNewton`GaussNewton, 
   SOP`SOPMakeFy, SOP`SOPJF, SOP`SOPGetY0, SOPCompiled`Private`a, 
   System`Association, SOPCompiled`engine, SOPCompiled`x1, 
  ...
  (System`ClearAll[SOP`SOPSolve]; PackageDeveloper`RedefinePublicFunction[
    ...
    System`Print[System`StackInhibit[Global`StackWithoutContexts[
        {"System`", "paul`"}]]]; System`Assert[System`False, System`Stack[]]; 
