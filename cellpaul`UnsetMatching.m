...
all DownValues start with HoldPattern\""}], ";", "\[IndentingNewLine]", 
          System`RowBox[{System`RowBox[{"paul`UnsetMatching", "[", "pat_", 
              "]"}], ":=", System`RowBox[{"UnsetHeldPattern", "/@", 
              System`RowBox[{"paul`FindMatchingDownValues", "[", "pat", 
                "]"}]}]}], ";"}]}], "\[IndentingNewLine]", "]"}], ";"}]], 
 "Input", System`CellChangeTimes -> {{3.6814856386386127*^9, 
  3.68148571188944*^9}, {3.6814880999213843*^9, 3.6814881060569787*^9}, 
  {3.681508711994563*^9, 3.68150871548492*^9}}]
