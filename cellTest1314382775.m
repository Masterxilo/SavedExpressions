         ...
         {"(", System`RowBox[{System`RowBox[{"id", "=", System`RowBox[{
                "RIFunctionMakeFromExpressionList", "[", System`RowBox[
                 {System`RowBox[{"{", "x", "}"}], ",", System`RowBox[
                   {"{", "x", "}"}]}], "]"}]}], ";"}], ")"}], ";", 
        System`RowBox[{"(", System`RowBox[{System`RowBox[{"idid", "=", 
              System`RowBox[{"RIFunctionMakeComposition", "[", System`RowBox[
                 {"id", ",", "id"}], "]"}]}], ";"}], ")"}], ";", 
        System`RowBox[{"RVVAsRules", "[", System`RowBox[
           {"RIFunctionEvaluateDerivative", "[", System`RowBox[
             {"idid", ",", "x", ",", System`RowBox[{"RVarvalMake", "[", 
                System`RowBox[{"{", System`RowBox[{"x", "\[Rule]", "2.`"}], 
                  "}"}], "]"}]}], "]"}], "]"}]}], ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[{"{", "1", "}"}], 
          "\[Rule]", "1.`"}], "}"}], ",", System`RowBox[{"{", "}"}], ",", 
      System`RowBox[{"{", "}"}]}], "]"}]], "Input", 
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {3.6816691911134295*^9}]
