System`Cell[System`BoxData[System`RowBox[{"Block", "[", 
    System`RowBox[{System`RowBox[{"{", "ff", "}"}], ",", 
      System`RowBox[{"PTest", "[", System`RowBox[
         {System`RowBox[{System`RowBox[{"(", System`RowBox[{"Null", ";"}], 
              ")"}], ";", System`RowBox[{"(", System`RowBox[{System`RowBox[
                 {"ff", "=", System`RowBox[{"RIFunctionMakePaired", "[", 
 ...
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {3.681669302161045*^9}]
