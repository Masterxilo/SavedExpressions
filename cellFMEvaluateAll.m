System`Cell[System`BoxData[System`RowBox[
   {"PRedefinePublicFunctionAlternatives", "[", "\n", 
    System`RowBox[{"\"f(A)\n\nin a list of the same order as \
FMDomain@f\n\nThis is similar to Values@Association\"", "\n", ",", "\n", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[{"FMEvaluateAll", "[", 
            ...
            "]"}], ",", System`RowBox[{"Values", "[", "assoc", "]"}]}], 
        "}"}], ",", System`RowBox[{"{", System`RowBox[
         {System`RowBox[{"FMEvaluateAll", "[", System`RowBox[
             {"f", ":", System`RowBox[{"FiniteMapping", "[", System`RowBox[
                 {"Lists", ",", "a_", ",", "fa_", ",", "vpf_"}], "]"}]}], 
            "]"}], ",", "fa"}], "}"}], ",", System`RowBox[
       {"{", System`RowBox[{System`RowBox[{"FMEvaluateAll", "[", 
            ...
            System`RowBox[{"array", ",", System`RowBox[{"level", "-", 
                "1"}]}], "]"}]}], "}"}], ",", System`RowBox[
       {"{", System`RowBox[{System`RowBox[{"FMEvaluateAll", "[", 
            "f_FiniteMapping", "]"}], ",", System`RowBox[
           {"FMEvaluateMultiple", "[", System`RowBox[{"f", ",", 
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6815674723302517*^9, 3.68156758311055*^9}, {3.681567682990239*^9, 
   ...
   3.68156923760701*^9}, 3.681574752299505*^9, 3.6816479348942385*^9}]
