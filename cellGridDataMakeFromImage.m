System`Cell[System`BoxData[System`RowBox[
   {"PRedefinePublicFunctionAlternatives", "[", "\n", 
    System`RowBox[{"\"from 2d or 3d  image with automatic dataNames\"", "\n", 
      ",", "\n", System`RowBox[{"{", System`RowBox[
         {System`RowBox[{"GridDataMakeFromImage", "[", System`RowBox[
             {"i", ":", System`RowBox[{"_Image", "|", "_Image3D"}]}], "]"}], 
          ",", System`RowBox[{"GridDataMakeFromArray", "[", 
            System`RowBox[{"ImageData", "[", "i", "]"}], "]"}]}], "}"}], ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[
           {"GridDataMakeFromImage", "[", System`RowBox[{"dataNames_List", 
              ",", System`RowBox[{"i", ":", System`RowBox[{"_Image", "|", 
                  "_Image3D"}]}]}], "]"}], ",", System`RowBox[
 ...
 System`CellChangeTimes -> {{3.6815674723302517*^9, 3.68156758311055*^9}, 
   ...
   3.681573167138605*^9}, 3.681648869299728*^9}]
