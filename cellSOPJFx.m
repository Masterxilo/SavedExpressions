System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{System`RowBox[{"SOPJFx", "[", System`RowBox[
...
buildFxandJFx, variable names are chosen to match\"", ",", "\n", "\n", 
  ...
  {3.6811516412714963*^9, 3.681151648693692*^9}, {3.6816499124930573*^9, 
  3.681649922188162*^9}}, System`CellTags -> 
  "depersistedCellfe3b0fa9-4a3d-4327-812b-41a2e8ef332d"]
