System`Cell[System`BoxData[System`RowBox[{"PTest", "[", 
    System`RowBox[{System`RowBox[{System`RowBox[
         {"(", System`RowBox[{System`RowBox[{"e", "=", System`RowBox[{"{", 
                System`RowBox[{System`RowBox[{System`RowBox[{"Cos", "[", "y", 
                      "]"}], "+", System`RowBox[{"Sin", "[", "x", "]"}]}], 
                  ",", System`RowBox[{"Tan", "[", "x", "]"}], ",", 
                  System`SqrtBox["y"]}], "}"}]}], ";"}], ")"}], ";", 
        ...
        System`RowBox[{"{", System`RowBox[{System`RowBox[{"FMAsRules", "[", 
              ...
              "]"}], ",", System`RowBox[{"Values", "[", System`RowBox[{
                ...
                "]"}], "]"}], ",", System`RowBox[{System`RowBox[{"jf", "=", 
                System`RowBox[{"RIFunctionMakeFullJacobian", "[", "f", 
                  "]"}]}], ";", System`RowBox[{"Values", "[", System`RowBox[
                 {"RVVAsRules", "[", System`RowBox[{"RIFunctionEvaluate", 
                    "[", System`RowBox[{"jf", ",", System`RowBox[
                       {"MakeConstantArguments", "[", "jf", "]"}]}], "]"}], 
                  "]"}], "]"}]}]}], "}"}]}], ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[
           {"{", System`RowBox[{System`RowBox[{System`RowBox[{"list", "[", 
                  System`RowBox[{System`RowBox[{"{", "1", "}"}], ",", "x"}], 
                  "]"}], "\[Rule]", System`RowBox[{"1.`", " ", System`RowBox[
                   {"Cos", "[", "x", "]"}]}]}], ",", System`RowBox[{
              ...
              System`RowBox[{System`RowBox[{"list", "[", System`RowBox[
                ...
                "\[Rule]", "0.`"}], ",", System`RowBox[{System`RowBox[
                 {"list", "[", System`RowBox[{System`RowBox[{"{", "1", "}"}], 
                    ",", "y"}], "]"}], "\[Rule]", System`RowBox[
                 {System`RowBox[{"-", "1.`"}], " ", System`RowBox[{"Sin", 
          ...
          System`RowBox[{System`RowBox[{"{", System`RowBox[{System`RowBox[
                 {"1.`", " ", System`RowBox[{"Cos", "[", "x", "]"}]}], ",", 
                System`RowBox[{"1.`", " ", System`SuperscriptBox[
                   System`RowBox[{"Sec", "[", "x", "]"}], "2"]}], ",", "0.`", 
