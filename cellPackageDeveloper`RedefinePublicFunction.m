System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"RedefinePublicFunction", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"Unprotect", "@", "RedefinePublicFunction"}], ";", 
        "\[IndentingNewLine]", System`RowBox[{"ClearAll", "@", 
          "RedefinePublicFunction"}], ";", "\n", System`RowBox[
         {System`RowBox[{"RedefinePublicFunction", "::", "usage"}], "=", "\"S\
ame as define, but first clears the symbol and its DownValueUsage\""}], ";", 
        ...
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"RedefinePublicFunction", "[", System`RowBox[
             {System`RowBox[{"attributes", ":", System`RowBox[{"{", "__", 
                  "}"}]}], ",", System`RowBox[{"d", ":", System`RowBox[
                 {"f_Symbol", "[", "args___", "]"}]}], ",", "usage_String", 
              ",", "body_", ",", System`RowBox[{"resultPattern_", ":", "_"}], 
        ...
        System`RowBox[{"Protect", "@", "RedefinePublicFunction"}], ";"}]}], 
