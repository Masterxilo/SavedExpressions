System`Cell[System`BoxData[
  {System`RowBox[{System`RowBox[{System`RowBox[{"UnprotectClearAll", "[", 
         System`RowBox[{"a", ",", "d", ",", "doriginal", ",", "eg", ",", 
           "er", ",", "es", ",", "ea", ",", "c", ",", "l"}], "]"}], ";"}], 
     System`RowBox[{"(*", System`RowBox[{"cannot", " ", "protect", " ", 
         System`RowBox[{"them", ":", " ", System`RowBox[{"FindMinimum", " ", 
             "uses", " ", "Block", " ", "to", " ", "localize", " ", 
             "them"}]}]}], "*)"}], "\[IndentingNewLine]"}], 
   "\[IndentingNewLine]", System`RowBox[{"PRedefinePublicFunction", "[", 
     "\[IndentingNewLine]", System`RowBox[
      {System`RowBox[{"SceneXEnergyf", "[", "\[IndentingNewLine]", 
         System`RowBox[{System`RowBox[{"colorDim", ":", "_Integer"}], ",", 
           "\[IndentingNewLine]", System`RowBox[
            {"lightIntensityParametrized", ":", "_"}], ",", 
           "\[IndentingNewLine]", System`RowBox[
            {"lightIntensityParameterCount", ":", "_Integer"}], ",", 
           "\[IndentingNewLine]", System`RowBox[{"dimension", ":", 
             System`RowBox[{"2", "|", "3"}]}]}], "]"}], 
       "\[IndentingNewLine]", "\[IndentingNewLine]", ",", "\"2 or 3 \
dimensional vsfs energy\n\nc,a,d,doriginal are indexed as *[{x, y (,z)}], -1 \
\[LessEqual] x,y(,z) \[LessEqual] 1, x,y,z \[Element] Z*)\n\nc is \
additionally indexed from 1 to colorDim, as in c[{x,y}, 1] etc.\n\nl is \
...
model,\ndefined by lightIntensityParametrized[l,n]\"", ",", 
       ...
       System`RowBox[{"Module", "[", "\[IndentingNewLine]", 
         System`RowBox[{System`RowBox[{"{", "\[IndentingNewLine]", 
             System`RowBox[{"forwardDifference", ",", "backwardDifference", 
               ...
               "trob", ",", "gamma", ",", "i", ",", System`RowBox[
                {"id", "=", System`RowBox[{"IdentityMatrix", "@", 
                   "dimension"}]}], ",", "lightIntensity", ",", 
               "\[IndentingNewLine]", "normal", ",", "n", ",", "b", ",", "v", 
               ",", "u", ",", "cv", ",", "normalize", ",", "norm"}], 
             "\[IndentingNewLine]", "}"}], ",", "\[IndentingNewLine]", 
           "\[IndentingNewLine]", System`RowBox[{System`RowBox[
              {System`RowBox[{System`RowBox[{"forwardDifference", "@", 
                   "f_"}], ":=", System`RowBox[{System`RowBox[{System`RowBox[
                      {"f", "[", System`RowBox[{"#", "+", "1"}], "]"}], "-", 
                     System`RowBox[{"f", "@", "#"}]}], "&"}]}], ";", 
               "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                  {"backwardDifference", "@", "f_"}], ":=", System`RowBox[
                  {System`RowBox[{System`RowBox[{"f", "@", "#"}], "-", 
                     System`RowBox[{"f", "[", System`RowBox[{"#", "-", "1"}], 
                       "]"}]}], "&"}]}], ";", "\[IndentingNewLine]", 
               System`RowBox[{System`RowBox[{"secondDifference", "@", "f_"}], 
                 ":=", System`RowBox[{"forwardDifference", "@", System`RowBox[
               ...
               "\[IndentingNewLine]", "\[IndentingNewLine]", System`RowBox[
                {System`RowBox[{"norm", "@", "x_"}], ":=", System`RowBox[
                  {"Sqrt", "@", System`RowBox[{"Norm2", "@", "x"}]}]}], 
               ";"}], System`RowBox[{"(*", System`RowBox[{"avoid", " ", 
                 "division", " ", "by", " ", "0"}], "*)"}], ";", 
             "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                {"normalize", "@", "x_"}], ":=", System`RowBox[{"x", "/", 
                 System`RowBox[{"(", System`RowBox[{"norm", "[", 
                     System`RowBox[{"x", "+", System`RowBox[{"0.0000001", 
                         "~", "Table", "~", "dimension"}]}], "]"}], 
                   ")"}]}]}], ";", System`RowBox[{"(*", System`RowBox[
                {System`RowBox[{"division", "!"}], " ", "TODO", " ", "is", 
                 " ", "this", " ", "a", " ", "good", " ", "way", " ", "to", 
                 " ", "avoid", " ", System`RowBox[{"it", "?"}]}], "*)"}], 
             "\[IndentingNewLine]", "\[IndentingNewLine]", System`RowBox[
              {"(*", System`RowBox[{"color", " ", "to", " ", "grayscale"}], 
               "*)"}], "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                {"cv", "@", "p_"}], ":=", System`RowBox[{"Array", "[", 
                 System`RowBox[{System`RowBox[{System`RowBox[{"c", "[", 
                       System`RowBox[{"p", ",", "#"}], "]"}], "&"}], ",", 
                   "colorDim"}], "]"}]}], ";", "\[IndentingNewLine]", 
             System`RowBox[{System`RowBox[{"i", "@", "p_"}], ":=", 
               System`RowBox[{"Mean", "@", System`RowBox[{"cv", "@", 
                   "p"}]}]}], ";", "\[IndentingNewLine]", System`RowBox[
              {System`RowBox[{"gamma", "@", "p_"}], ":=", System`RowBox[
                {System`RowBox[{"cv", "@", "p"}], "/", System`RowBox[
                  {"(", System`RowBox[{System`RowBox[{"i", "@", "p"}], "+", 
                     "1"}], ")"}]}]}], ";", System`RowBox[
              {"(*", System`RowBox[{"division", "!"}], "*)"}], 
             System`RowBox[{"(*", System`RowBox[{System`RowBox[{"+", "1"}], 
                 " ", "to", " ", "avoid", " ", "division", " ", "by", " ", 
                 "0"}], "*)"}], "\[IndentingNewLine]", "\[IndentingNewLine]", 
             System`RowBox[{"(*", System`RowBox[{System`RowBox[{"falloff", 
                   " ", System`RowBox[{"function", ":", " ", System`RowBox[
                      {"large", " ", "x"}]}]}], " ", "\[Rule]", " ", 
                 System`RowBox[{"small", " ", "values"}]}], "*)"}], 
             "\[IndentingNewLine]", System`RowBox[{"trob", "=", "3"}], ";", 
             System`RowBox[{System`RowBox[{"phi", "@", "x_"}], ":=", 
             ...
             "\[IndentingNewLine]", System`RowBox[{"Join", "[", 
               "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                  ...
                  {"(*", System`RowBox[{"alternative", ":", System`RowBox[
                      {"eg", System`RowBox[{"(", System`RowBox[{System`RowBox[
                          {"b", "@", "v"}], "-", System`RowBox[{"i", "@", 
                          "v"}]}], ")"}]}]}], "*)"}], "\[IndentingNewLine]", 
                 System`RowBox[{"er", "*", System`RowBox[{"{", System`RowBox[
                      {System`RowBox[{"laplacian", "[", "d", "]"}], "@", 
                       "v"}], "}"}]}], ",", "\[IndentingNewLine]", 
                 System`RowBox[{"es", "*", System`RowBox[{"{", System`RowBox[
                      {System`RowBox[{"d", "@", "v"}], "-", System`RowBox[
                        {"doriginal", "@", "v"}]}], "}"}]}], ",", 
                 "\[IndentingNewLine]", System`RowBox[{"ea", "*", 
                   System`RowBox[{"Table", "[", System`RowBox[{System`RowBox[
                        {System`RowBox[{"Sqrt", "@", System`RowBox[{"phi", 
                          "[", System`RowBox[{"norm", "[", System`RowBox[
                          {System`RowBox[{"gamma", "@", "v"}], "-", 
                          System`RowBox[{"gamma", "@", "u"}]}], "]"}], 
                          "]"}]}], System`RowBox[{"(", System`RowBox[
                          {System`RowBox[{"a", "@", "v"}], "-", System`RowBox[
                          {"a", "@", "u"}]}], ")"}]}], ",", System`RowBox[
                        {"{", System`RowBox[{"u", ",", System`RowBox[
 ...
 "Input", System`CellChangeTimes -> {{3.680252807354599*^9, 
  ...
  3.680932880607691*^9}}, System`CellID -> 591844988]
