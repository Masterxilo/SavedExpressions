        ...
        "\[IndentingNewLine]", System`RowBox[{"Module", "[", 
          "\[IndentingNewLine]", System`RowBox[
           {System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[{
                "forwardDifference", ",", "backwardDifference", ",", 
                "secondDifference", ",", "gradient", ",", "forwardGradient", 
                ...
                "\[IndentingNewLine]", "normal", ",", "n", ",", "b", ",", 
                "v", ",", "u", ",", "cv", ",", "normalize", ",", "norm"}], 
              "\[IndentingNewLine]", "}"}], ",", "\[IndentingNewLine]", 
            "\[IndentingNewLine]", System`RowBox[{System`RowBox[{
                ...
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                   {"gradient", "[", System`RowBox[{"f_", ",", System`RowBox[
                    ...
                    "]"}], ":=", System`RowBox[{"Function", "[", 
                    System`RowBox[{System`RowBox[{"{", "p", "}"}], ",", 
                      System`RowBox[{"Table", "[", System`RowBox[
                         {System`RowBox[{"With", "[", System`RowBox[
                          {System`RowBox[{"{", System`RowBox[{"w", "=", 
                          "v"}], "}"}], ",", System`RowBox[{System`RowBox[
                          {"differenceFunction", "[", System`RowBox[
                          {System`RowBox[{"f", "[", System`RowBox[{"p", "+", 
                          "w"}], "]"}], "&"}], "]"}], "@", "0"}]}], "]"}], 
                          ",", System`RowBox[{"{", System`RowBox[{"v", ",", 
                          System`RowBox[{"#", " ", "id"}]}], "}"}]}], 
                        "]"}]}], "]"}]}], ";", "\[IndentingNewLine]", 
                System`RowBox[{System`RowBox[{"forwardGradient", "@", "f_"}], 
                  ":=", System`RowBox[{"gradient", "[", System`RowBox[
                     {"f", ",", "forwardDifference"}], "]"}]}], ";", 
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                ...
                System`RowBox[{"gamma", "@", "p_"}], ":=", System`RowBox[
                 {System`RowBox[{"cv", "@", "p"}], "/", System`RowBox[
                   {"(", System`RowBox[{System`RowBox[{"i", "@", "p"}], "+", 
                      "1"}], ")"}]}]}], ";", System`RowBox[{"(*", 
                System`RowBox[{"division", "!"}], "*)"}], System`RowBox[{
                "(*", System`RowBox[{System`RowBox[{"+", "1"}], " ", "to", 
                  " ", "avoid", " ", "division", " ", "by", " ", "0"}], 
                "*)"}], "\[IndentingNewLine]", "\[IndentingNewLine]", 
