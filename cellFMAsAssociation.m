System`Cell[System`BoxData[System`RowBox[
   {"PRedefinePublicFunctionAlternatives", "[", "\n", 
    System`RowBox[{"\"As an association\"", "\n", ",", "\n", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[{"FMAsAssociation", 
            "[", System`RowBox[{"f", ":", System`RowBox[{"FiniteMapping", 
                "[", System`RowBox[{"Rules", ",", "assoc_Association"}], 
                "]"}]}], "]"}], ",", "assoc"}], "}"}], ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[{"FMAsAssociation", 
            "[", "f_FiniteMapping", "]"}], ",", System`RowBox[
           {"Association", "[", System`RowBox[{"FMAsRules", "[", "f", "]"}], 
            "]"}]}], "}"}]}], "\n", "]"}]], "Code", 
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {{3.6815674723302517*^9, 
   ...
   {3.6815690458566294*^9, 3.681569062634576*^9}, 3.6815747516767287*^9, 
   3.6816352905996475*^9}]
