System`HoldComplete[Global`NeedsDefined[Scene2D`Scene2DShowAlbedo, 
   Scene2D`Scene2DShowColor, Scene2D`Scene2DShowDistanceField, 
   Scene2D`Scene2DGridDataNames]; PackageDeveloper`RedefinePublicFunction[
   Scene2D`Scene2DShow[Global`s_Scene2D`Scene2D], 
