System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"ShowDistanceField3D", ",", "\[IndentingNewLine]", 
      System`RowBox[{System`RowBox[{System`RowBox[{"ShowDistanceField3D", 
            "::", "usage"}], "=", "\"ShowDistanceField3D[data] visualizes a \
3d distance field defined by bilinear interpolation of distance values \
defined at grid points\""}], ";", "\[IndentingNewLine]", 
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"Options", "[", "ShowDistanceField3D", "]"}], "=", 
        ...
        "\n", "\n", System`RowBox[{System`RowBox[
           {"paul`ShowDistanceField3DAxesLabel", "[", "]"}], " ", "=", " ", 
          System`RowBox[{"{", System`RowBox[{"\"dim1\"", ",", " ", 
              "\"dim2\"", ",", "\n", "  ", "\"dim3\""}], "}"}]}], ";", 
        System`RowBox[{"(*", System`RowBox[{"{", System`RowBox[
             {"\"x\"", ",", "\"y\"", ",", "\"z\""}], "}"}], "*)"}], "\n", 
        System`RowBox[{System`RowBox[{"paul`ShowDistanceFieldInside", "[", 
            "]"}], " ", "=", " ", System`RowBox[
           {System`RowBox[{"ColorData", "[", "\"RedGreenSplit\"", "]"}], "@", 
            "0"}]}], ";", "\n", System`RowBox[
         {System`RowBox[{"paul`ShowDistanceFieldOutside", "[", "]"}], " ", 
          "=", " ", System`RowBox[{System`RowBox[{"ColorData", "[", 
              "\"RedGreenSplit\"", "]"}], "@", "1"}]}], ";", "\n", 
        System`RowBox[{System`RowBox[{"paul`ShowDistanceField3DContourStyle", 
            "[", "]"}], "=", " ", System`RowBox[{"{", System`RowBox[
             {"FaceForm", "[", System`RowBox[{System`RowBox[
                 {"paul`ShowDistanceFieldOutside", "[", "]"}], ",", 
                System`RowBox[{"paul`ShowDistanceFieldInside", "[", "]"}]}], 
              "]"}], "}"}]}], ";", "\[IndentingNewLine]", " ", "\n", 
        System`RowBox[{System`RowBox[{"ShowDistanceField3D", "[", 
          ...
          System`RowBox[{System`RowBox[{System`RowBox[{System`RowBox[
                 {"{", System`RowBox[{"smm", " ", "=", " ", System`RowBox[
                     {"SymmetricMinMax", "@", "data"}]}], "}"}], "~", "With", 
                "~", System`RowBox[{"Graphics3D", "[", System`RowBox[
                   {System`RowBox[{"{", "\n", "  ", System`RowBox[
                       {System`RowBox[{"Point", "@", System`RowBox[{"Table", 
                          "[", System`RowBox[{"1", ",", " ", "3"}], "]"}]}], 
                        ",", "\n", "  ", System`RowBox[{"Translate", "[", 
                          "\n", "    ", System`RowBox[{System`RowBox[
                          {"Raster3D", "[", System`RowBox[{System`RowBox[
                          ...
                          "[", System`RowBox[{"0.5", ",", " ", "3"}], 
                          "]"}]}], "]"}]}], "\n", "}"}], "\n", "  ", ",", 
                    " ", System`RowBox[{"Axes", " ", "->", " ", "True"}], 
                    "\n", "  ", ",", " ", System`RowBox[{"AxesLabel", " ", 
                      "->", " ", System`RowBox[
                       {"paul`ShowDistanceField3DAxesLabel", "[", "]"}]}], 
                   ...
                   {"(", "\n", "      ", System`RowBox[{System`RowBox[
                      ...
                      "\n", "\n", "      ", System`RowBox[{"Framed", "@", 
                        System`RowBox[{"Column", "@", System`RowBox[{"{", 
                          ...
                          "True"}], "\n", "            ", ",", " ", 
                          System`RowBox[{"AxesLabel", " ", "->", " ", 
                          System`RowBox[{"paul`ShowDistanceField3DAxesLabel", 
                          "[", "]"}]}], "\n", "            ", ",", " ", 
                          System`RowBox[{"AxesOrigin", " ", "->", " ", 
                          System`RowBox[{"Table", "[", System`RowBox[{"1", 
                          ",", " ", "3"}], "]"}]}], "\n", "            ", 
  ...
  {{3.6814915944665747*^9, 3.6814916012590547*^9}, {3.681493498491832*^9, 
  3.681493501760828*^9}, {3.6814969700182433*^9, 3.681496983783862*^9}, 
  {3.681497042074939*^9, 3.6814970906588554*^9}, {3.681497137392027*^9, 
  3.6814972726432643*^9}}]
