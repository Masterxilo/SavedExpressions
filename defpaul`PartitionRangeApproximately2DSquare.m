System`HoldComplete[PackageDeveloper`RedefinePublicFunction[
  paul`PartitionRangeApproximately2DSquare[Global`min_System`Integer, 
...
coordinates.\n", System`Module[{Global`r}, 
   Global`r = paul`PartitionRangeApproximately[Global`min, Global`max, 
      Global`nSplits]; System`CoordinateBoundsArray /@ 
     System`Tuples[Global`r, 2]], {_?(paul`ArrayQOp[3, System`IntegerQ])..}, 
  ""]]
