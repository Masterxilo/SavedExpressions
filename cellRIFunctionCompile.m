System`Cell[System`BoxData[System`RowBox[
   {"PRedefinePublicFunctionAlternatives", "[", 
    System`RowBox[{"\"TODO this should happen automatically ideally\"", ",", 
      "\[IndentingNewLine]", "\[IndentingNewLine]", 
      System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"RIFunctionCompile", "[", System`RowBox[
             {"rif", ":", System`RowBox[{"RIFunction", "[", System`RowBox[
                 {"Compiled", ",", "___"}], "]"}]}], "]"}], 
          "\[IndentingNewLine]", ",", "\[IndentingNewLine]", "rif"}], 
        "\[IndentingNewLine]", "}"}], ",", "\[IndentingNewLine]", 
 ...
 System`CellChangeTimes -> {{3.680965048016087*^9, 3.680965188148472*^9}, 
   {3.680965955108102*^9, 3.680965967452384*^9}, {3.6809660415658865*^9, 
   3.6809660500974784*^9}, {3.6809660854682493*^9, 3.6809660972969*^9}, 
   3.6809661796525483*^9, {3.680967855498143*^9, 3.6809678712629104*^9}, 
   {3.6811275803153067*^9, 3.6811276321829624*^9}, 3.6816553415247154*^9, 
   {3.6816557540787296*^9, 3.6816557948426337*^9}}, 
