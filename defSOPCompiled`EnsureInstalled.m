   ...
   System`Catch[System`Module[{}, 
     System`If[SOPCompiled`$InstalledExe === SOPCompiled`Private`a[
      ...
      System`Print[System`VerificationTest[System`HoldForm[
         SOPCompiled`Private`get42[]], 42]]; SOPCompiled`Private`printv[
       System`RandomReal[1., {100}]]; SOPCompiled`Private`testMain[]; 
      SOPCompiled`Private`print["POST ends"]; System`Print[
       System`LinkPatterns[SOPCompiled`$InstalledLink]]; ]], _]]
