System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{System`RowBox[{"SOP`SparseOptimizationProblemMake", "[", 
...
a SparseOptimization problem in the format covered here\"", ",", 
          ...
          "\[IndentingNewLine]", System`RowBox[
           {"SOP`SparseOptimizationProblemMakeFromShared", "[", 
            System`RowBox[{"p", ",", "y", ",", System`RowBox[{
                "SOP`SOPMakeShared", "[", System`RowBox[{"rif", ",", 
                  "select", ",", "data"}], "]"}]}], "]"}]}], 
        "\[IndentingNewLine]", "]"}], "\[IndentingNewLine]", ",", 
      System`RowBox[{System`RowBox[{"SOP`SparseOptimizationProblem", "[", 
          "a_Association", "]"}], "/;", System`RowBox[
         {System`RowBox[{System`RowBox[{"a", "@", "\"lengthFx\""}], ">", 
            "0"}], "&&", System`RowBox[{System`RowBox[{"a", "@", 
              "\"lengthY\""}], ">", "0"}], "&&", System`RowBox[
           {System`RowBox[{"a", "@", "\"lengthp\""}], ">", "0"}], "&&", 
          System`RowBox[{System`RowBox[{"a", "@", "\"lengthz\""}], ">", 
            "0"}], "&&", System`RowBox[{System`RowBox[{"a", "@", 
              "\"lengthfz\""}], ">", "0"}]}]}]}], "\[IndentingNewLine]", 
    "]"}]], "Input", System`CellChangeTimes -> {{3.6803792555247297*^9, 
   ...
   3.681124465617787*^9, {3.6811245561858215*^9, 3.6811245614352937*^9}, 
   {3.6811272582037096*^9, 3.681127357732815*^9}, {3.6811276573325186*^9, 
   3.681127676657339*^9}, {3.681134884414493*^9, 3.6811349346037197*^9}, 
   {3.6815868152606373*^9, 3.681586862921133*^9}}, 
