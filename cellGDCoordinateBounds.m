System`Cell[System`BoxData[System`RowBox[
   {System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
      System`RowBox[{System`RowBox[{"GDCoordinateBounds", "[", "g_GridData", 
          "]"}], "\n", "  ", ",", "\"coordinate bounds of domain. determine \
the range of indices that are valid/min/max.\"", "\n", "  ", ",", 
 ...
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {{3.6815682608556404*^9, 
   ...
   3.68157351190701*^9}, 3.681573561428832*^9, {3.6815745047955275*^9, 
   3.681574513424296*^9}, 3.681635294009921*^9}]
