System`HoldComplete[Global`NeedsDefined[
  ...
  PackageDeveloper`RedefinePublicFunction[Scene2D`Scene2DTests[
    ...
    System`With[{SOPCompiled`Private`a = System`Symbol["a"], 
     ...
     Testing`RunHeldVerificationTests[
      {System`Hold[System`VerificationTest[Scene2D`Scene2DEnergy[
         ...
         Scene2D`Scene2DEnergyColorDim[Scene2D`Scene2DEnhance[
            Global`trivialScene2D]] == Scene2D`Scene2DEnergyColorDim[
           Global`trivialScene2D], System`True, {}, {}]], 
       System`Hold[System`VerificationTest[Scene2D`Scene2DEnergyColorDim[
           Scene2D`Scene2DEnhance[Global`scene2dMake1]] == 
          Scene2D`Scene2DEnergyColorDim[Global`scene2dMake1], System`True, 
         {}, {}]], System`Hold[System`VerificationTest[
         System`Round[Scene2D`Scene2DEnergy[Scene2D`Scene2DMake1[]]], 45, {}, 
         {}]], System`Hold[System`VerificationTest[System`Round[
          Scene2D`Scene2DEnergy[Scene2D`Scene2DEnhance[Scene2D`Scene2DMake1[
             ]]]], 16, {}, {}]], System`Hold[System`VerificationTest[
         Scene2D`Scene2DEnergy[Scene2D`Scene2DEnhance[Scene2D`Scene2DMake1[
             ]]] < Scene2D`Scene2DEnergy[Scene2D`Scene2DMake1[]], 
         System`True, {}, {}]], System`Hold[System`VerificationTest[
         Scene2D`Scene2DEnergy[Scene2D`Scene2DEnhance[
           Scene2D`Scene2DMakeTrivial[], System`Method -> "SOPCompiled"]], 
         Scene2D`Scene2DEnergy[Scene2D`Scene2DEnhance[
           Scene2D`Scene2DMakeTrivial[], System`Method -> "GaussNewton"]], 
