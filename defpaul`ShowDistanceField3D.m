System`HoldComplete[paul`ShowDistanceField3D::usage = "ShowDistanceField3D[da\
ta] visualizes a 3d distance field defined by bilinear interpolation of \
distance values defined at grid points"; 
  System`Options[paul`ShowDistanceField3D] = 
   {System`Method -> System`ListPlot, System`PerformanceGoal -> "Speed"}; 
  paul`ShowDistanceField3D[Global`data_ /; System`ArrayQ[Global`data, 3, 
      System`NumericQ], System`OptionsPattern[]] := 
   paul`ShowDistanceField3D[Global`data, System`OptionValue[System`Method], 
    System`OptionValue[System`PerformanceGoal]]; 
  paul`ShowDistanceField3DAxesLabel[] = {"dim1", "dim2", "dim3"}; 
  paul`ShowDistanceFieldInside[] = System`ColorData["RedGreenSplit"][0]; 
  paul`ShowDistanceFieldOutside[] = System`ColorData["RedGreenSplit"][1]; 
  paul`ShowDistanceField3DContourStyle[] = 
   {System`FaceForm[paul`ShowDistanceFieldOutside[], 
     paul`ShowDistanceFieldInside[]]}; 
  paul`ShowDistanceField3D[Global`data_ /; System`ArrayQ[Global`data, 3, 
      System`NumericQ], System`Image3D, _] := 
   System`With[{Global`smm = paul`SymmetricMinMax[Global`data]}, 
      System`Graphics3D[{System`Point[System`Table[1, 3]], 
       ...
       System`Axes -> System`True, System`AxesLabel -> 
        paul`ShowDistanceField3DAxesLabel[], System`AxesOrigin -> 
        ...
        System`Transpose[{System`Table[0.5, 3], 0.5 + System`Dimensions[
            Global`data]}]]]*paul`ShowDistanceField3D[
      ...
      Global`contourPlotPlaceholderUpdate, Global`f = 
       paul`LinearListInterpolation[Global`idata], Global`contour, 
      ...
      System`Quiet[System`AbortKernels[]]; Global`tdata = 
       ...
       Global`lowQualityContourPlot[] := System`MemoryConstrained[
         System`ListContourPlot3D[Global`tdata, System`Contours -> 
          ...
          System`ContourStyle -> paul`ShowDistanceField3DContourStyle[]], 
       ...
       Global`highQualityContourPlot[] := System`MemoryConstrained[
         System`ContourPlot3D[Global`f[Global`x, Global`y, Global`z], 
          ...
          System`Mesh -> System`None, System`ContourStyle -> 
           System`Reverse[paul`ShowDistanceField3DContourStyle[]]], 
         Global`memoryConstraint, Global`contourPlotPlaceholder]; 
       System`DistributeDefinitions[paul`ShowDistanceField3DContourStyle, 
       ...
       Global`contourPlotPlaceholderUpdate[] := 
        paul`ParallelSubmitPlaceholderMultiple[Global`contourPlotPlaceholder, 
         {Global`computedContour = Global`contour; Global`result = 
            Global`lowQualityContourPlot[]; System`If[Global`contour === 
             Global`computedContour, Global`result, 
            Global`contourPlotPlaceholder], Global`computedContour = 
            Global`contour; Global`result = Global`mediumQualityContourPlot[
             ]; System`If[Global`contour === Global`computedContour, 
            Global`result, Global`contourPlotPlaceholder], 
          Global`computedContour = Global`contour; Global`result = 
            Global`highQualityContourPlot[]; System`If[Global`contour === 
             Global`computedContour, Global`result, 
            Global`contourPlotPlaceholder]}]; 
       Global`densityPlotPlaceholderUpdate[] := 
        paul`ParallelSubmitPlaceholderMultiple[Global`densityPlotPlaceholder, 
         {System`Image3D[Global`tdata, System`ColorFunction -> 
            (System`Append[System`ColorData[{"RedGreenSplit", Global`smm}][
               #1], 0.5] & )], System`MemoryConstrained[
           System`ListDensityPlot3D[Global`tdata, System`ColorFunction -> 
             Global`cf, System`ColorFunctionScaling -> System`False, 
            System`DataRange -> Global`dr, System`BoxRatios -> 
       ...
       Global`contourPlotPlaceholderUpdate[]; System`Framed[
        System`Column[{{"contour", System`Slider[System`Dynamic[
          ...
          System`Dynamic[System`Show[System`Graphics3D[System`Point[
             ...
             System`AxesLabel -> paul`ShowDistanceField3DAxesLabel[], 
