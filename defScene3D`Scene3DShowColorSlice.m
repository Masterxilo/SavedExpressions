System`HoldComplete[Global`NeedsDefined[
   ...
   System`First, Scene3D`Scene3DCoordinateBounds, System`Image, 
   GridData`GDSingleDatumToArray, GridData`GDRestDimension, 
  ...
  PackageDeveloper`RedefinePublicFunction[
   Scene3D`Scene3DShowColorSlice[Global`s_Scene3D`Scene3D, 
     ...
     System`First[Scene3D`Scene3DCoordinateBounds[Global`s]]], "Visualize \
surface lambertian-lit color, one layer\n\nTODO other cross-sections, \
general", System`Image[GridData`GDSingleDatumToArray[
