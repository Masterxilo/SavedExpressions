System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"SOPSolveForY", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"SOPSolveForY", "//", "UnprotectClearAll"}], ";", 
...
numeric vector y1 with which the given sop would have less energy\"", ",", 
          ...
          "\[IndentingNewLine]", "]"}], ";", "\[IndentingNewLine]", 
        System`RowBox[{"Unprotect", "@", "SOPSolveForY"}], ";", 
                     ...
                     {"iterations", ",", "\[IndentingNewLine]", 
                      "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                         {System`RowBox[{"{", System`RowBox[{"finalEnergy", 
                          ...
                          "\[IndentingNewLine]", System`RowBox[{"SOPJFy", 
                          "[", System`RowBox[{"p", ",", "y1"}], "]"}], ",", 
                          "\[IndentingNewLine]", "y1"}], 
                          "\[IndentingNewLine]", "]"}]}], ";"}]}], 
                    "\[IndentingNewLine]", "\[IndentingNewLine]", "]"}], ";", 
          ...
          System`RowBox[{System`RowBox[{"SOPSolveForY", "[", System`RowBox[{
            ...
            "\[IndentingNewLine]", System`RowBox[{"Module", "[", 
              System`RowBox[{System`RowBox[{"{", System`RowBox[{"engine", 
                    ",", "y1"}], "}"}], ",", "\[IndentingNewLine]", 
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                   {"engine", "=", System`RowBox[{"SOPCompiledPrepare", "@", 
                      System`RowBox[{"a", "@", "\"rif\""}]}]}], ";", 
                  "\[IndentingNewLine]", "\[IndentingNewLine]", System`RowBox[
                   {"(*", System`RowBox[{"Size", " ", "dependent"}], "*)"}], 
                  "\[IndentingNewLine]", System`RowBox[{"y1", "=", 
                    System`RowBox[{"SOPCompiledOptimizePreprocessed", "[", 
 ...
 System`CellChangeTimes -> {{3.6802750153689146*^9, 3.6802752055382013*^9}, 
   ...
   {3.6811339079637613*^9, 3.681133960641507*^9}, {3.6811339931031694*^9, 
   3.6811340801438327*^9}, {3.681134150301581*^9, 3.681134211174858*^9}, 
   {3.6811510252655525*^9, 3.681151058698228*^9}, {3.6811510984473753*^9, 
   3.681151148264715*^9}, {3.681151528081287*^9, 3.6811516203294306*^9}, 
   {3.681586968311702*^9, 3.681587062453227*^9}, {3.6815871105412602*^9, 
   3.6815871128701677*^9}, {3.681587172141161*^9, 3.681587172970196*^9}, 
   {3.6816499125931826*^9, 3.6816499222392273*^9}, {3.681650226282874*^9, 
   3.681650226284878*^9}, {3.681654623625497*^9, 3.68165463217115*^9}, 
   {3.68165476303053*^9, 3.6816547765393934*^9}, 3.681654814819182*^9}, 
