System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"LetL", ",", "\[IndentingNewLine]", "\[IndentingNewLine]", 
      System`RowBox[{System`RowBox[{System`RowBox[{"LetL", "::", "usage"}], 
          "=", "\"Like With, but later constants can refer to earlier ones. \
Prefer With[{x=0},{y=x},...]\""}], ";", "\[IndentingNewLine]", 
        "\[IndentingNewLine]", "\[IndentingNewLine]", 
        System`RowBox[{"SetAttributes", "[", System`RowBox[
           {"LetL", ",", "HoldAll"}], "]"}], ";", "\n", 
              ...
              ",", System`RowBox[{System`RowBox[{System`RowBox[{"Attributes", 
                 ...
                 {"With", "[", System`RowBox[{System`RowBox[{"{", "head", 
                      ...
                      System`RowBox[{"LetL", "[", System`RowBox[
                        ...
                        "]"}], "]"}]}], "]"}]}]}], "]"}]}], ";", 
        "\[IndentingNewLine]", "\[IndentingNewLine]", 
        System`RowBox[{"LetL", "//", "MakeUndefinedFunction"}], ";"}]}], 
    "\[IndentingNewLine]", "]"}]], "Input", System`CellChangeTimes -> 
  {{3.6814915944665747*^9, 3.6814916012590547*^9}, {3.681491708146721*^9, 
  3.681491714842043*^9}, {3.681504862761755*^9, 3.6815048890869064*^9}}]
