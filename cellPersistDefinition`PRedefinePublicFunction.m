System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"PRedefinePublicFunction", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"Unprotect", "@", "PRedefinePublicFunction"}], ";", 
        "\[IndentingNewLine]", System`RowBox[{"ClearAll", "[", 
          "PRedefinePublicFunction", "]"}], ";", "\[IndentingNewLine]", 
        "\[IndentingNewLine]", System`RowBox[
         {System`StyleBox[System`RowBox[{"PRedefinePublicFunction", "::", 
             "usage"}], "MessageName"], "=", "\"PRedefinePublicFunction[f[x,y\
,...] /; cond, usage, body] Idiom for calling RedefinePublicFunction within \
Persist. cond is optional\""}], ";", "\[IndentingNewLine]", 
        ...
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{System`RowBox[{"PRedefinePublicFunction", "[", 
              System`RowBox[{System`RowBox[{"attributes", ":", System`RowBox[
                   {"{", "__", "}"}]}], ",", System`RowBox[{"\[FormalD]", 
                  ":", System`RowBox[{System`RowBox[{"(", System`RowBox[
                       {"\[FormalF]", ":", System`RowBox[{"Except", "[", 
                          System`RowBox[{"Condition", ",", "_Symbol"}], 
                          "]"}]}], ")"}], "[", "___", "]"}]}], ",", 
                "\[FormalU]_String", ",", "\[FormalE]_", ",", System`RowBox[
                 {"Optional", "[", System`RowBox[{System`RowBox[
                     {"expectedType", ":", System`RowBox[{"Except", "[", 
                        System`RowBox[{"Options", "\[Rule]", "_"}], "]"}]}], 
                    ",", "_"}], "]"}], ",", System`RowBox[{"Optional", "[", 
            ...
            System`RowBox[{"\[FormalF]", ",", System`RowBox[{
                "RedefinePublicFunction", "[", System`RowBox[{"attributes", 
