System`HoldComplete[Global`NeedsDefined[System`CompoundExpression, 
   PackageDeveloper`RedefinePublicFunction, Global`Scene3DEnhance, 
   ...
   Global`Scene3DMakeFromSparseOptimizationProblem, SOP`SOPSolve, 
   ...
   System`List, System`Null]; (PackageDeveloper`RedefinePublicFunction[
    Global`Scene3DEnhance[Global`s_Scene3D`Scene3D, 
     SceneX`weights:SceneX`$SceneXEnergyWeightPattern:
...
model", Global`Scene3DMakeFromSparseOptimizationProblem[
    ...
    _Scene3D`Scene3D]; System`Options[Global`Scene3DEnhance] = 
