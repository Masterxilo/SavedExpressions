System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"SOPJF", "[", System`RowBox[{"sop", ":", 
...
variable names are chosen to match\"", ",", "\n", 
      System`RowBox[{"SOPJFx", "[", System`RowBox[{"sop", ",", 
          System`RowBox[{"a", "@", "\"x0\""}]}], "]"}]}], 
  ...
  {{3.6809481480578337*^9, 3.6809485399270377*^9}, {3.680948570770688*^9, 
   ...
   {3.6811513400133314*^9, 3.6811513538420715*^9}, {3.681649912479039*^9, 
   3.681649922185141*^9}}, System`CellTags -> 
  "depersistedCell6eb3b4f5-7a5c-458f-b978-c6234657af97"]
