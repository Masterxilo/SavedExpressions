...
optimization Framework for the given function\"", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[{"Module", "[", 
        System`RowBox[{System`RowBox[{"{", System`RowBox[{"fn", ",", "fng", 
          ...
          System`RowBox[{System`RowBox[{System`RowBox[{"fn", "@", "s_"}], 
            ...
            "\[IndentingNewLine]", System`RowBox[{"targetName", "=", 
              System`RowBox[{"\"Framework\"", "<>", System`RowBox[
                 {"ToString", "@", System`RowBox[{"Hash", "[", System`RowBox[
                     {"rif", ",", "\"CRC32\""}], "]"}]}]}]}], ";", 
            ...
            System`RowBox[{"If", "[", System`RowBox[{System`RowBox[
                ...
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                   {"TaskKill", "[", System`RowBox[{"targetName", "<>", 
                      "\".exe\""}], "]"}], ";", "\[IndentingNewLine]", 
                  System`RowBox[{"Print", "@", System`RowBox[{"MSBuild", "[", 
                      System`RowBox[{System`RowBox[{"fn", "@", 
                          "\"Framework.sln\""}], ",", System`RowBox[{"{", 
                          System`RowBox[{"\"/p:TargetName=\"", "<>", 
                          "targetName"}], "}"}]}], "]"}]}]}]}], 
              "\[IndentingNewLine]", "]"}], ";", "\[IndentingNewLine]", 
            "\[IndentingNewLine]", System`RowBox[{"SOPCompiled`SOPCompiled", 
              "[", System`RowBox[{"Association", "[", "\[IndentingNewLine]", 
                System`RowBox[{System`RowBox[{"\"rif\"", "\[Rule]", "rif"}], 
 ...
 System`CellChangeTimes -> {{3.681029702527623*^9, 3.6810299120821843*^9}, 
   ...
   {3.681047478522208*^9, 3.681047479224801*^9}}, 
 System`CellTags -> "depersistedCell095ba9bf-a40a-4dc9-9c3e-d6606f242e29"]
