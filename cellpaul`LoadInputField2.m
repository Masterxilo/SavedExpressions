              ...
              System`RowBox[{System`RowBox[{"paul`NotebookAllDeleteCells", 
                ...
                "\[IndentingNewLine]", System`RowBox[{"If", "[", 
                  System`RowBox[{System`RowBox[{System`RowBox[{"Head", "[", 
                    ...
                    "\[IndentingNewLine]", ",", System`RowBox[{"CellPrint", 
                      "[", System`RowBox[{"Append", "[", System`RowBox[
                         {System`RowBox[{"paul`MakeInputCell", "[", 
                          System`RowBox[{"Unevaluated", "[", System`RowBox[
                          {"Persist", "[", System`RowBox[{"s", ",", "Null"}], 
                          "]"}], "]"}], "]"}], ",", System`RowBox[
                          {"CellTags", "\[Rule]", System`RowBox[
                          {"\"depersistedCell\"", "<>", "id"}]}]}], "]"}], 
                      "]"}]}], "]"}]}]}], "\[IndentingNewLine]", "]"}]}], 
        ";", "\[IndentingNewLine]", "\[IndentingNewLine]", 
        System`RowBox[{System`RowBox[{"paul`LoadInputField2", "[", "]"}], 
          ":=", System`RowBox[{"With", "[", System`RowBox[
             {System`RowBox[{"{", System`RowBox[{"id", "=", System`RowBox[
                   {"CreateUUID", "[", "]"}]}], "}"}], ",", "\n", 
              System`RowBox[{"CellPrint", "[", System`RowBox[{"Append", "[", 
