System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"ShowDistanceField", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"ShowDistanceField", "//", "UnprotectClearAll"}], ";", 
...
points\""}], ";", "\[IndentingNewLine]", System`RowBox[
        ...
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"ShowDistanceFieldAxesLabel", "[", "]"}], "=", 
                   ...
                   {System`RowBox[{"DensityPlot", "[", "\n", "      ", 
                      System`RowBox[{System`RowBox[{"f", "[", System`RowBox[
                        ...
                        System`RowBox[{"FrameLabel", " ", "\[Rule]", " ", 
                          System`RowBox[{"ShowDistanceFieldAxesLabel", "[", 
                          "]"}]}]}], "\n", "    ", "]"}], "\n", "    ", ",", 
                    " ", System`RowBox[{"ContourPlot", "[", System`RowBox[
   ...
   3.6814916012590547*^9}, {3.6814934825451827*^9, 3.6814934863038397*^9}, 
   {3.681493528792269*^9, 3.681493532672765*^9}, {3.68149746491858*^9, 
   3.6814975584191675*^9}, {3.681497609606244*^9, 3.681497618715934*^9}, 
   3.6816417467134776*^9, {3.681641788265351*^9, 3.6816417882733607*^9}, 
   {3.6816425621434546*^9, 3.681642572573475*^9}}]
