System`Cell[System`BoxData[System`RowBox[{"Block", "[", 
    System`RowBox[{System`RowBox[{"{", "a", "}"}], ",", 
      System`RowBox[{"PTest", "[", System`RowBox[
         {System`RowBox[{"GDAsRules", "[", System`RowBox[
             {"GDSubsetCoordinateBounds", "[", System`RowBox[{System`RowBox[
                 {"GridDataMakeFromRules", "[", System`RowBox[{System`RowBox[
                     {"{", "a", "}"}], ",", System`RowBox[{"{", System`RowBox[
                       {System`RowBox[{System`RowBox[{"{", System`RowBox[
                          {"1", ",", "1"}], "}"}], "\[Rule]", System`RowBox[
                          {"{", "0", "}"}]}], ",", System`RowBox[
