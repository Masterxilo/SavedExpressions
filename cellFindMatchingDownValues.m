    ...
    System`RowBox[{"FindMatchingDownValues", ",", "\[IndentingNewLine]", 
      System`RowBox[{System`RowBox[{"UnprotectClearAll", "@", 
        ...
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"FindMatchingDownValues", "::", "usage"}], "=", "\"U\
ses Cases on DownValues of the appropriate symbol to find all definitions \
that apply\""}], ";", "\[IndentingNewLine]", System`RowBox[
         {"FindMatchingDownValues", "~", "SetAttributes", "~", "HoldAll"}], 
        ";", "\[IndentingNewLine]", System`RowBox[
  ...
  {{3.681488215322603*^9, 3.6814882430572224*^9}, {3.681507519606996*^9, 
   ...
   3.6816417413808208*^9, {3.6816419995170755*^9, 3.6816420045914106*^9}}]
