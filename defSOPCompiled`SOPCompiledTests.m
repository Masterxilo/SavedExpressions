System`HoldComplete[Global`NeedsDefined[
   ...
   SOPCompiled`Private`x, SceneX`select, System`Set, Scene2D`f, 
   ...
   System`Range, System`Null, System`SameTest, numerics`ApproximatelyEqual, 
   System`Power, SOP`sop, SOP`SparseOptimizationProblemMake, 
   SOP`SOPDataAsRules, SOP`SOPSolve, System`Values]; 
  PackageDeveloper`RedefinePublicFunction[SOPCompiled`SOPCompiledTests[
    Global`silent_:System`True], "", Testing`RunHeldVerificationTests[
    {System`Hold[System`VerificationTest[
        System`ClearAll[SOPCompiled`Private`x, SceneX`select]; 
         Scene2D`f = {SOPCompiled`Private`x}; 
         ...
         SOP`ps = {0}; Scene2D`data = {SOPCompiled`Private`x -> 2.}; 
         Global`ys = {SOPCompiled`Private`x}; 
        ...
        {{0.}, {0.}}, {}, {}]], System`Hold[System`VerificationTest[
       (System`ClearAll[SceneX`select, Scene2D`f, SOPCompiled`Private`x, 
          SOPCompiled`Private`y]; Scene2D`f = {2*SOPCompiled`Private`y, 
        ...
        (SOPCompiled`engine = SOPCompiled`SOPCompiledPrepare[
           SOPCompiled`SOPCompiledMakeRIFunction[Scene2D`f, SceneX`select]]; 
         SOPCompiled`SOPCompiledOptimize[SOPCompiled`engine, SceneX`select, 
          SOP`ps, Scene2D`data, Global`ys]), {0., 0.}, {}, 
