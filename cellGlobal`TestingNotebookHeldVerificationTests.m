System`Cell[System`BoxData[System`RowBox[{"Global`PRedefinePublicFunction", 
    "[", "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"Global`TestingNotebookHeldVerificationTests", "[", 
...
list of Hold VerificationTest items from the current testing notebook\"", 
           ...
           {System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[{
                ...
                System`RowBox[{System`RowBox[{"(", System`RowBox[{"m", ":", 
                      System`RowBox[{"Cell", "[", System`RowBox[{"___", ",", 
                          "\"ExpectedMessage\"", ",", "___"}], "]"}]}], 
                    ")"}], "~", "Optional", "~", 
                  "Global`EmptyListInputCell"}], ",", "\[IndentingNewLine]", 
                System`RowBox[{System`RowBox[{"(", System`RowBox[{"p", ":", 
                      System`RowBox[{"Cell", "[", System`RowBox[{"___", ",", 
                          "\"TestOptions\"", ",", "___"}], "]"}]}], ")"}], 
                  "~", "Optional", "~", "Global`EmptyListInputCell"}]}], 
              "\[IndentingNewLine]", "\[IndentingNewLine]", "}"}], 
  ...
  3.680695367308037*^9}}, System`CellTags -> 
  "depersistedCell892cc1b5-b8a0-4933-92b1-2a88d9261a85"]
