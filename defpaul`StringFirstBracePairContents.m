System`HoldComplete[PackageDeveloper`RedefinePublicFunction[
  paul`StringFirstBracePairContents[Global`s_System`String], "StringFirstBrac\
ePairContents[\"whatever (contents(y)) (more braces) x\"] returns \
contents(y)", System`Module[{Global`cnt, Global`depth = 0, Global`cont = "", 
    ...
    System`Catch[paul`CharacterMap[Global`cnt, Global`s]]], _, ""]]
