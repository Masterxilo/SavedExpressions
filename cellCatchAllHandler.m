System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"CatchAllHandler", ",", "\[IndentingNewLine]", 
      System`RowBox[{System`RowBox[{"UnprotectClearAll", "@", 
          "CatchAllHandler"}], ";", "\[IndentingNewLine]", 
          ...
          System`RowBox[{"With", "[", System`RowBox[{System`RowBox[{"{", 
                ...
                System`RowBox[{"(*", System`RowBox[{"catch", " ", "stuff", 
                 ...
                 {System`RowBox[{"Throw", "[", System`RowBox[{System`RowBox[
                   ...
                   {"#1", "&"}]}], "]"}]}], "]"}]}], ";", "\n", 
        "\[IndentingNewLine]", "\[IndentingNewLine]", 
        System`RowBox[{"CatchAllHandler", "//", 
          "MakeUndefinedFunctionProtect"}], ";"}]}], "\[IndentingNewLine]", 
    "\[IndentingNewLine]", "]"}]], "Input", System`CellChangeTimes -> 
  {{3.6814915944665747*^9, 3.6814916012590547*^9}, {3.6814921859041443*^9, 
   3.681492190345376*^9}, {3.681505294249304*^9, 3.6815053312367554*^9}, 
   3.6816417395265055*^9, {3.6816418879017363*^9, 3.6816418993830695*^9}}]
