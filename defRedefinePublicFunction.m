System`HoldComplete[Global`UnprotectClearAll[Global`RedefinePublicFunction]; 
  ...
  Global`RedefinePublicFunction[Global`attributes:{___}:{}, 
    Global`d:System`Verbatim[System`Condition][
      (Global`f:System`Except[System`List | System`Condition, 
         _System`Symbol])[Global`args___], Global`c_], 
    Global`usage_System`String, Global`body_, 
  ...
  Global`RedefinePublicFunction[Global`attributes:{___}:{}, 
    Global`d:(Global`f:System`Except[System`List | System`Condition, 
        _System`Symbol])[Global`args___], Global`usage_System`String, 
