System`Cell[System`BoxData[System`RowBox[
   {System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
      System`RowBox[{System`RowBox[{"GDAppendDimension", "[", 
          System`RowBox[{"g_GridData", ",", " ", System`RowBox[
             {"x0_Integer", " ", ":", " ", "1"}]}], "]"}], "\n", "\n", "  ", 
        ",", "\"{position} -> {position, x0}\n\n    x0 defaults to 1\"", 
        "\n", "\n", "  ", ",", System`RowBox[{"GDMapPositions", "[", 
          System`RowBox[{System`RowBox[{System`RowBox[{"#", "~", "Append", 
                "~", "x0"}], " ", "&"}], ",", " ", "g"}], "]"}]}], "\n", 
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6815682608556404*^9, 3.681568263299692*^9}, {3.681568309008765*^9, 
   ...
   3.6815735943078794*^9}, {3.681573675570326*^9, 3.681573825170085*^9}, 
   3.68163529385773*^9}]
