...
returns the given value, capturing the AbsoluteTiming of evaluation\"", ",", 
 ...
 "Input", System`CellChangeTimes -> {{3.6814915944665747*^9, 
  3.6814916012590547*^9}, {3.6814936080272446*^9, 3.681493609761609*^9}, 
  {3.6814936922340994*^9, 3.6814936982719193*^9}, {3.6814949733289347*^9, 
  3.681494973969588*^9}, {3.681496558492853*^9, 3.6814965714494247*^9}}]
