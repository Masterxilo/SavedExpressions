...
pointer-following/array indexing).\"", ",", "\[IndentingNewLine]", 
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6814915944665747*^9, 3.6814916012590547*^9}, {3.6814917947256813*^9, 
   3.681491798951989*^9}, 3.681491832928876*^9, {3.681502801010533*^9, 
   3.681502810585349*^9}, 3.6816417464361315*^9}]
