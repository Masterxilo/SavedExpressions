System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"FirstStringPosition", ",", "\[IndentingNewLine]", 
      System`RowBox[{System`RowBox[{"UnprotectClearAll", "@", 
          "FirstStringPosition"}], ";", "\[IndentingNewLine]", 
...
string.\""}], ";", "\[IndentingNewLine]", "\[IndentingNewLine]", 
   ...
   3.6814916012590547*^9}, {3.6814928022732596*^9, 3.6814928119706783*^9}, 
   {3.6815004695620937*^9, 3.681500494955736*^9}, 3.681641741671183*^9, 
   {3.681642012381143*^9, 3.681642020338069*^9}}]
