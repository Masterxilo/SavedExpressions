...
a SparseOptimization problem in the format covered here\"", ",", 
 ...
 System`CellChangeTimes -> {{3.6803792555247297*^9, 3.680379272605027*^9}, 
   ...
   {3.681134884414493*^9, 3.6811349346037197*^9}, {3.6815868152606373*^9, 
   3.681586862921133*^9}, {3.681649912740366*^9, 3.6816499222602344*^9}, 
   3.68165469893351*^9}, System`CellTags -> 
