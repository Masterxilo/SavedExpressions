...
HoldPattern and Unsets the corresponding definition without evaluating it.\""}\
         ...
         {System`RowBox[{"UnsetHeldPattern", "[", System`RowBox[
             {System`RowBox[{"Verbatim", "[", "HoldPattern", "]"}], "[", 
              "definition_", "]"}], "]"}], ":=", "\[IndentingNewLine]", 
          System`RowBox[{"Unset", "[", "definition", "]"}]}], ";", 
        "\[IndentingNewLine]", System`RowBox[{"Protect", "@", 
          "UnsetHeldPattern"}], ";"}]}], "\[IndentingNewLine]", "]"}]], 
 "Input", System`CellChangeTimes -> {{3.6814915944665747*^9, 
   3.6814916012590547*^9}, {3.6814935587924347*^9, 3.6814935783394623*^9}, 
   {3.6815059055327854*^9, 3.6815059160684633*^9}, {3.681507110098769*^9, 
   3.6815071250404367*^9}, {3.681508357147574*^9, 3.6815083633363028*^9}, 
   {3.6815084134108133*^9, 3.6815084260035515*^9}, 3.6815084943158293*^9, 
   {3.6815085926385612*^9, 3.6815086703926272*^9}, 3.6815090083450055*^9, 
   {3.681535870111309*^9, 3.6815358774447913*^9}}]
