...
necessary\nand throws an assertion error if this is not possible.\"", ",", 
 ...
 System`CellChangeTimes -> {{3.6814915944665747*^9, 3.6814916199914393*^9}, 
   {3.681504647967953*^9, 3.681504653409199*^9}, {3.681504693577217*^9, 
   3.681504693624094*^9}, 3.6815361152416496*^9, {3.681536228835462*^9, 
   3.681536245146946*^9}, {3.681557255676882*^9, 3.6815572737396517*^9}}]
