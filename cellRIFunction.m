System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"RIFunction", ",", "\[IndentingNewLine]", 
      ...
      System`RowBox[{"(*", System`RowBox[{"TODO", " ", "Hold", " ", "expr", 
        ...
        "*)"}], System`RowBox[{"(*", System`RowBox[{"TODO", " ", "add", " ", 
          ...
          System`RowBox[{"(", System`RowBox[{"not", " ", "just", " ", "list", 
              " ", "indexed"}], ")"}], " ", "outputs"}], "*)"}], 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"UnprotectClearAll", "@", "RIFunction"}], ";", 
        "\[IndentingNewLine]", System`RowBox[{"RIFunction", "~", 
          "SetAttributes", "~", "HoldAllComplete"}], ";", 
        "\[IndentingNewLine]", System`RowBox[{"Protect", "@", "RIFunction"}], 
        ";"}]}], "\[IndentingNewLine]", "]"}]], "Input", 
 System`CellChangeTimes -> {{3.6809410587287254*^9, 3.6809410961404104*^9}, 
   {3.6809411264852734*^9, 3.680941144479723*^9}, 3.6809655022093544*^9, 
   {3.6816553416779065*^9, 3.6816553716573324*^9}, {3.6816555439183664*^9, 
   3.681655544806493*^9}, {3.6816555953105245*^9, 3.6816556079943743*^9}}, 
