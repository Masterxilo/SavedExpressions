System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
             ...
             {"(", "\[IndentingNewLine]", System`RowBox[{"(*", "Setup", 
                ...
                "\[IndentingNewLine]", "\[IndentingNewLine]", System`RowBox[
                 {"Testing`RunHeldVerificationTests", "[", System`RowBox[
                   {System`RowBox[{"{", System`RowBox[{System`RowBox[{"Hold", 
                        ...
                        ",", System`RowBox[{"Hold", "[", System`RowBox[
                         ...
                         {"Hold", "[", System`RowBox[{"VerificationTest", 
                          "[", System`RowBox[{System`RowBox[{"{", 
                          System`RowBox[{System`RowBox[{
                          "SOPFullyAbstractfAt", "[", System`RowBox[
                          {"soptest", ",", System`RowBox[{"Last", "[", 
                          "ptest", "]"}]}], "]"}], ",", System`RowBox[
                          {"SOPFullyAbstractfAt", "[", System`RowBox[
                        ...
                        System`RowBox[{"Hold", "[", System`RowBox[
                         ...
                         {"Hold", "[", System`RowBox[{"VerificationTest", 
                          "[", System`RowBox[{System`RowBox[
                          {"SOPEnergyVector", "[", System`RowBox[{"soptest", 
                          ",", System`RowBox[{"SOPMakeXWithY", "[", 
                          System`RowBox[{"soptest", ",", System`RowBox[{"{", 
                          "42.`", "}"}]}], "]"}]}], "]"}], ",", System`RowBox[
                          {"{", System`RowBox[{System`RowBox[{"{", 
                          System`RowBox[{"43.`", ",", "1.`"}], "}"}], ",", 
                          System`RowBox[{"{", System`RowBox[{"44.`", ",", 
                          "2.`"}], "}"}]}], "}"}], ",", System`RowBox[{"{", 
                          "}"}], ",", System`RowBox[{"{", "}"}]}], "]"}], 
                          "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                        ...
                        System`RowBox[{"Hold", "[", System`RowBox[
                          {"VerificationTest", "[", System`RowBox[
                          {System`RowBox[{"SOPObjectiveExpression", "[", 
                          "soptest", "]"}], ",", System`RowBox[{"5.`", 
                          "\[VeryThinSpace]", "+", System`SuperscriptBox[
                          System`RowBox[{"(", System`RowBox[{"1.`", 
                          "\[VeryThinSpace]", "+", "x"}], ")"}], "2"], "+", 
                          System`SuperscriptBox[System`RowBox[{"(", 
                          System`RowBox[{"2.`", "\[VeryThinSpace]", "+", 
                          "x"}], ")"}], "2"]}], ",", System`RowBox[{"{", 
                          "}"}], ",", System`RowBox[{"{", "}"}]}], "]"}], 
                          "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                          ...
                          "]"}], "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                          System`RowBox[{System`RowBox[{"SOPGetY0", "[", 
                          "soptest", "]"}], ",", System`RowBox[{"{", "0.`", 
                          "}"}], ",", System`RowBox[{"{", "}"}], ",", 
                          System`RowBox[{"{", "}"}]}], "]"}], "]"}], ",", 
                        System`RowBox[{"Hold", "[", System`RowBox[
                          {"VerificationTest", "[", System`RowBox[
                          {System`RowBox[{System`RowBox[{"SOPMakeFy", "[", 
                          "soptest", "]"}], "[", System`RowBox[{"SOPGetY0", 
                          "[", "soptest", "]"}], "]"}], ",", System`RowBox[
                          {"SOPFx", "[", "soptest", "]"}], ",", System`RowBox[
                          {"{", "}"}], ",", System`RowBox[{"{", "}"}]}], 
                          "]"}], "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                          System`RowBox[{System`RowBox[
                        ...
                        System`RowBox[{"Hold", "[", System`RowBox[
                          ...
                          System`RowBox[{"VerificationTest", "[", 
                          System`RowBox[{System`RowBox[{"x", "/.", 
                          "\[VeryThinSpace]", System`RowBox[{"SOPYData", "[", 
                          "soptest", "]"}]}], ",", "0.`", ",", System`RowBox[
                          {"{", "}"}], ",", System`RowBox[{"{", "}"}]}], 
                          "]"}], "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                          System`RowBox[{System`RowBox[{"x", "/.", 
                          "\[VeryThinSpace]", System`RowBox[{"SOPYData", "[", 
                          System`RowBox[{"SOPSolve", "[", "soptest", "]"}], 
                          "]"}]}], ",", System`RowBox[{"-", "1.5`"}], ",", 
                          System`RowBox[{"{", "}"}], ",", System`RowBox[
                        ...
                        System`RowBox[{"Hold", "[", System`RowBox[
                          ...
                          System`RowBox[{"SOPJF", "[", "soptest", "]"}], 
                          "]"}], ",", System`RowBox[{"1.`", " ", 
                          System`RowBox[{System`SubscriptBox["\[PartialD]", 
                          System`RowBox[{"{", "ytest", "}"}]], System`RowBox[
                          {"Flatten", "[", System`RowBox[{
                ...
                ";", "\[IndentingNewLine]", "\[IndentingNewLine]", 
                System`RowBox[{"(*", "Setup", "*)"}], "\[IndentingNewLine]", 
                System`RowBox[{System`RowBox[{"select", "[", "_", "]"}], 
                  ":=", System`RowBox[{"{", System`RowBox[{"x", "\[Rule]", 
                      "x"}], "}"}]}], ";", "\[IndentingNewLine]", 
                System`RowBox[{"ys", "=", System`RowBox[{"{", "x", "}"}]}], 
                 ...
                 {"Testing`RunHeldVerificationTests", "[", System`RowBox[
                   {System`RowBox[{"{", "\[IndentingNewLine]", System`RowBox[
                       {System`RowBox[{"Hold", "[", System`RowBox[
                          ...
                          "]"}], ",", System`RowBox[{"Hold", "[", 
                          System`RowBox[{"VerificationTest", "[", 
                          System`RowBox[{System`RowBox[{"SOPyIndices", "[", 
                          System`RowBox[{"xs", ",", "ys"}], "]"}], ",", 
                          System`RowBox[{"{", "1", "}"}], ",", System`RowBox[
                          {"{", "}"}], ",", System`RowBox[{"{", "}"}]}], 
                          "]"}], "]"}]}], "\[IndentingNewLine]", "}"}], ",", 
                ...
                "\[IndentingNewLine]", System`RowBox[{"(*", "Setup", "*)"}], 
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                   {"select", "[", "i_", "]"}], ":=", System`RowBox[
                   {"{", System`RowBox[{System`RowBox[{"x", "[", "0", "]"}], 
                      "\[Rule]", System`RowBox[{"x", "[", "i", "]"}]}], 
                    "}"}]}], ";", "\[IndentingNewLine]", System`RowBox[
                 {"ys", "=", System`RowBox[{"{", System`RowBox[{System`RowBox[
                       {"x", "[", "0", "]"}], ",", System`RowBox[{"x", "[", 
                        "1", "]"}]}], "}"}]}], ";", "\[IndentingNewLine]", 
                System`RowBox[{"xs", "=", System`RowBox[{"{", System`RowBox[
                ...
                System`RowBox[{System`RowBox[{"select", "[", "i_", "]"}], 
                  ":=", System`RowBox[{"{", System`RowBox[{System`RowBox[
                       {"x", "[", "0", "]"}], "\[Rule]", System`RowBox[
                       {"x", "[", "i", "]"}]}], "}"}]}], ";", 
                "\[IndentingNewLine]", System`RowBox[{"ys", "=", 
                  System`RowBox[{"{", System`RowBox[{"x", "[", "0", "]"}], 
                    "}"}]}], ";", "\[IndentingNewLine]", System`RowBox[
                 {"xs", "=", System`RowBox[{"{", System`RowBox[{System`RowBox[
                       {"x", "[", "0", "]"}], ",", System`RowBox[{"x", "[", 
                        "1", "]"}]}], "}"}]}], ";", "\[IndentingNewLine]", 
 ...
 System`CellChangeTimes -> {{3.6811470519648542*^9, 3.6811472659403286*^9}, 
   {3.6811473027170935*^9, 3.6811473661370254*^9}, {3.681147511203945*^9, 
   3.6811477511852503*^9}, {3.6811478829656267*^9, 3.6811479171679745*^9}, 
   {3.681148014688136*^9, 3.681148054168397*^9}, {3.6811482313531833*^9, 
   3.681148269246014*^9}, {3.6811483675896597*^9, 3.6811485071853695*^9}, 
   3.681148571919382*^9, 3.68114863061771*^9, {3.681148707261814*^9, 
   3.6811487092150345*^9}, {3.6811487493154774*^9, 3.681148784199309*^9}, 
   3.6811489339299393*^9, {3.681149002098735*^9, 3.6811490375971437*^9}}, 
