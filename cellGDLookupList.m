System`Cell[System`BoxData[System`RowBox[
   {System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
      System`RowBox[{System`RowBox[{System`RowBox[{"GDLookupList", "[", "\n", 
            "  ", System`RowBox[{System`RowBox[{"g", " ", ":", " ", 
                System`RowBox[{"GridData", "[", System`RowBox[
                   {"dataNames_List", ",", " ", "f_FiniteMapping"}], "]"}]}], 
              "\n", "  ", ",", " ", System`RowBox[{"position", " ", ":", " ", 
                System`RowBox[{"{", "__Integer", "}"}]}]}], "\n", "]"}], " ", 
          "/;", " ", System`RowBox[{"g", "~", "GDCoordinateQ", "~", 
            "position"}]}], "\n", "\n", ",", "\"get data at point as List in \
same order as DataNames\n\nThis gives the RHS expected in the rule \
constructors\"", "\n", "\n", ",", System`RowBox[{"f", "~", "FMEvaluate", "~", 
          "position"}]}], "\n", "]"}], ";"}]], "Code", 
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {{3.6815682608556404*^9, 
   ...
   {3.681573675570326*^9, 3.6815736883392677*^9}, 3.681635294195136*^9}]
