System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"RIFunctionEvaluate", ",", "\n", 
      ...
      System`RowBox[{"(*", "\n", System`RowBox[
         {System`RowBox[{"TODO", " ", "not", " ", "all", " ", "arguments", 
            ...
            "the", " ", "RVarval", " ", System`RowBox[{"matter", "?", "\n", 
              "TODO"}], " ", "What", " ", "if", " ", "the", " ", "amount", 
            " ", "of", " ", "arguments", " ", "is", " ", "correct", " ", 
            "but", " ", "not", " ", "the", " ", "names", " ", "of", " ", 
            System`RowBox[{"them", "?", "\n", "\n", "TODO"}], " ", "some", 
            " ", "of", " ", "these", " ", "could", " ", "be", " ", 
            "implemented", " ", "using", " ", "the", " ", "Nameless", " ", 
            "variant"}], ",", " ", System`RowBox[{"then", " ", "adding", " ", 
            "the", " ", "names", " ", "in", " ", "the", " ", "end", "\n", 
            " ", "when", " ", "will", " ", "this", " ", "be", " ", 
            System`RowBox[{"faster", "?"}]}]}], "\n", "*)"}], "\n", "\n", 
      System`RowBox[{"(*", " ", "Name", " ", "*)"}], "\n", 
       ...
       {System`RowBox[{"RedefinePublicFunction", "[", "\n", 
          System`RowBox[{System`RowBox[{"RIFunctionEvaluate", "[", 
              System`RowBox[{System`RowBox[{"RIFunction", "[", System`RowBox[
                   {"Composition", ",", " ", "f_RIFunction", ",", " ", 
                    "g_RIFunction"}], "]"}], ",", " ", "args_RVarval"}], 
              "]"}], "\n", "  ", ",", "\"f(args)\"", "\n", "  ", ",", "\n", 
            "    ", System`RowBox[{"(", "\n", "      ", System`RowBox[{"f", 
                "~", "RIFunctionEvaluate", "~", System`RowBox[{"RVarvalMake", 
                  "[", System`RowBox[{System`RowBox[{"RIFunctionArguments", 
                      "@", "f"}], ",", " ", System`RowBox[{"RVVValues", "@", 
        ...
        System`RowBox[{"DefinePublicFunction", "[", "\n", 
            ...
            System`RowBox[{"Module", "[", System`RowBox[{System`RowBox[
                 {"{", "}"}], ",", " ", System`RowBox[{"Null", "\n", "\n", 
                  ";", " ", System`RowBox[{"RVarvalMake", "[", System`RowBox[
                     {"expr", " ", "/.", " ", System`RowBox[{"RVVAsRules", 
                        "@", "args"}]}], "]"}]}]}], " ", System`RowBox[{"(*", 
                " ", System`RowBox[{System`RowBox[{System`RowBox[{"TODO", 
                      " ", "compare"}], " ", "/.", " ", System`RowBox[
                     {"with", " ", "other", " ", "ways", " ", "of", " ", 
                      "inserting", " ", "values"}]}], ",", " ", System`RowBox[
                   {"Block", " ", "is", " ", "probably", " ", "more", " ", 
                    "efficient", " ", "but", " ", "error", " ", System`RowBox[
                     {"prone", "?"}]}]}], " ", "*)"}], "\n", "\n", "]"}]}], 
          "\n", "  ", "]"}], ";", "\n", "\n", System`RowBox[
            ...
            "  ", ",", System`RowBox[{"Module", "[", System`RowBox[{
                System`RowBox[{"{", "}"}], ",", " ", System`RowBox[
                 {"Null", "\n", "\n", ";", " ", System`RowBox[{"RVarvalMake", 
                    "[", System`RowBox[{"outputs", ",", " ", System`RowBox[
                       {"expr", " ", "/.", " ", System`RowBox[{"RVVAsRules", 
                          "@", "args"}]}]}], "]"}]}]}], " ", System`RowBox[{
                "(*", " ", System`RowBox[{System`RowBox[{System`RowBox[
                     {"TODO", " ", "compare"}], " ", "/.", " ", System`RowBox[
                     {"with", " ", "other", " ", "ways", " ", "of", " ", 
                      "inserting", " ", "values"}]}], ",", " ", System`RowBox[
                   {"Block", " ", "is", " ", "probably", " ", "more", " ", 
                    "efficient", " ", "but", " ", "error", " ", System`RowBox[
         ...
         {"(*", " ", System`RowBox[{System`RowBox[{"f", System`RowBox[{"(", 
                "x", ")"}], System`RowBox[{"(", System`RowBox[{"pairing", 
                  "[", System`RowBox[{"k", ",", " ", "j"}], "]"}], ")"}]}], 
          ...
          System`RowBox[{System`RowBox[{"RIFunctionEvaluate", "[", "\n", 
            ...
            System`RowBox[{"With", "[", System`RowBox[{System`RowBox[
                ...
                "\n", "  ", System`RowBox[{"RVarvalMakePairIndexed", "[", 
                  System`RowBox[{"k", ",", " ", System`RowBox[{System`RowBox[
                       {System`RowBox[{"#", "~", "RIFunctionEvaluate", "~", 
                          "args"}], " ", "&"}], " ", "/@", " ", System`RowBox[
                       {"FMEvaluateAll", "@", "components"}]}], ",", " ", 
                    "pairing"}], "]"}]}], "\n", "\n", "  ", "]"}]}], "\n", 
          "  ", "]"}], ";", "\n", System`RowBox[{"(*", " ", 
          System`RowBox[{System`RowBox[{"select", System`RowBox[{"(", "x", 
                ")"}], System`RowBox[{"(", "a", ")"}]}], " ", "=", " ", 
            System`RowBox[{"x", System`RowBox[{"(", System`RowBox[
                 {"s", System`RowBox[{"(", "a", ")"}]}], ")"}]}]}], "  ", 
          "*)"}], "\n", System`RowBox[{"DefinePublicFunction", "[", "\n", 
          System`RowBox[{System`RowBox[{System`RowBox[{"RIFunctionEvaluate", 
                "[", "\n", "\n", System`RowBox[{"(*", " ", "Arguments", " ", 
                  "*)"}], " ", System`RowBox[{System`RowBox[
                   {"PatternSequence", "[", "]"}], "\n", "\n", "  ", ",", 
                  " ", System`RowBox[{"RIFunction", "[", System`RowBox[
                  ...
                  " ", "args_RVarval"}], "\n", System`RowBox[{"(*", " ", 
                  "Code", " ", "*)"}], " ", "]"}], " ", "/;", " ", 
              System`RowBox[{System`RowBox[{"RVVLength", "@", "args"}], " ", 
                "==", " ", System`RowBox[{"Length", "@", "b"}]}]}], " ", ",", 
            "\"\"", ",", " ", System`RowBox[{"With", "[", System`RowBox[{
                System`RowBox[{"{", "}"}], ",", "\n", "\n", "  ", 
                System`RowBox[{"RVarvalMake", "[", System`RowBox[{"a", ",", 
                    ...
                    System`RowBox[{"f", "~", "RIFunctionEvaluate", "~", 
                      System`RowBox[{"RVarvalSlicePairIndexed", "[", 
                        System`RowBox[{"args", ",", " ", "p", ",", " ", 
                          "pairing"}], "]"}]}], "\n", "\n", "      ", ",", 
                    " ", System`RowBox[{"{", System`RowBox[{"p", ",", "ps"}], 
                      "}"}]}], "\n", "\n", "      ", "]"}], "\n", "\n", 
                "    ", ",", " ", "pairing"}], "\n", "  ", "]"}]}], "\n", 
          "]"}], ";"}]}], "\[IndentingNewLine]", "]"}]], "Input", 
 System`CellChangeTimes -> {{3.6809423585055513*^9, 3.6809423763408146*^9}, 
   {3.680942445443014*^9, 3.680942485714278*^9}, 3.6809442480933247*^9, 
   3.680945070850938*^9, 3.6809451426975884*^9, 3.6816553415837893*^9, 
   {3.681655818975746*^9, 3.6816558315164194*^9}}, 
