System`HoldComplete[Global`PTestRun[{}, Global`WrapInBlockIfNeeded[
   System`Hold[Global`PTest[
     (Global`sx = Global`RIFunctionMakeFromExpressionList[
      ...
      (Global`csx = Global`RIFunctionMakeComposition[Global`cx, 
         Global`sx]; ); {Global`FMAsRules[
        Global`RIFunctionOutputExpressionMap[Global`csx]], 
     ...
     {{{1} -> System`Cos[System`Sin[Global`x]]}, 
      ...
      {1.*System`D[System`Cos[System`Sin[Global`x]], Global`x]} /. 
       Global`x -> 0.4, {{1} -> -1*0.3496811475077381}}, {}, {}]]], 
  System`Hold[System`Block[{Global`sx, Global`cx, Global`csx}, 
    Global`PTest[(Global`sx = Global`RIFunctionMakeFromExpressionList[
         {System`Sin[Global`x]}, {Global`x}]; ); 
      (Global`cx = Global`RIFunctionMakeFromExpressionList[
         {System`Cos[Global`x]}, {Global`x}]; ); 
      (Global`csx = Global`RIFunctionMakeComposition[Global`cx, 
