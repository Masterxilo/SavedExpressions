System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
                  ...
                  "\[IndentingNewLine]", "\[IndentingNewLine]", System`RowBox[
                   {System`RowBox[{System`RowBox[{"ClearAll", "[", 
                      ...
                      System`RowBox[{System`RowBox[{"select", "[", "i_", 
                        ...
                        System`RowBox[{"{", System`RowBox[{"x", ",", "y"}], 
                          "}"}]}], ";", System`RowBox[{"ps", "=", 
                        System`RowBox[{"Range", "[", "10", "]"}]}], ";", 
                      System`RowBox[{"data", "=", System`RowBox[{"{", 
                          System`RowBox[{System`RowBox[{"x", "\[Rule]", 
                          "2.`"}], ",", System`RowBox[{"y", "\[Rule]", 
                          "3.`"}]}], "}"}]}], ";", System`RowBox[{"engine", 
                   ...
                   {System`RowBox[{System`RowBox[{System`RowBox[{"select", 
                      ...
                      System`RowBox[{"sop", "=", System`RowBox[
                         {"SparseOptimizationProblemMake", "[", System`RowBox[
                          ...
                          {"2", " ", "y"}], ",", System`RowBox[{"x", "+", 
                          System`RowBox[{"3", " ", "y"}]}]}], "}"}], ",", 
                          "select", ",", System`RowBox[{"Range", "[", "10", 
                          "]"}], ",", System`RowBox[{"{", System`RowBox[
                          {System`RowBox[{"x", "\[Rule]", "2.`"}], ",", 
                          System`RowBox[{"y", "\[Rule]", "3.`"}]}], "}"}], 
                          ",", System`RowBox[{"{", System`RowBox[{"x", ",", 
                          "y"}], "}"}]}], "]"}]}], ";", System`RowBox[
                       {"Values", "[", System`RowBox[{"SOPDataAsRules", "[", 
                          System`RowBox[{"SOPSolve", "[", System`RowBox[
                          {"sop", ",", System`RowBox[{"Method", "\[Rule]", 
                          "\"SOPCompiled\""}]}], "]"}], "]"}], "]"}]}], 
                    "\[IndentingNewLine]", "\[IndentingNewLine]", ",", 
                    System`RowBox[{"{", System`RowBox[{"0.`", ",", "0.`"}], 
                      "}"}], "\[IndentingNewLine]", "\[IndentingNewLine]", 
                    ",", System`RowBox[{"{", "}"}], ",", System`RowBox[
                     {"{", System`RowBox[{"SameTest", "\[Rule]", 
                        System`RowBox[{"ApproximatelyEqual", "[", 
                          System`FractionBox["1", System`SuperscriptBox["10", 
                          "4"]], "]"}]}], "}"}]}], "]"}], "]"}]}], "}"}], 
          "\[IndentingNewLine]", "\[IndentingNewLine]", ",", "silent"}], 
 ...
 System`CellChangeTimes -> {{3.6811492231991425*^9, 3.6811492249648247*^9}, 
   ...
   3.681149533113432*^9, {3.681152344253524*^9, 3.681152357347385*^9}, 
   {3.6811525688181763*^9, 3.681152588394846*^9}, {3.681153796989333*^9, 
   3.6811538198671074*^9}, {3.6811546875823536*^9, 3.6811546884717674*^9}, 
   {3.681199286326686*^9, 3.681199302039241*^9}, {3.6811993801495447*^9, 
   3.681199398743781*^9}, {3.6811994385071473*^9, 3.681199438694641*^9}}, 
