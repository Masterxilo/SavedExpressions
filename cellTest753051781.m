    ...
    System`RowBox[{System`RowBox[{"{", "v", "}"}], ",", 
      System`RowBox[{"PTest", "[", System`RowBox[
         {System`RowBox[{"ArrayReshape", "[", System`RowBox[
             {"v", ",", System`RowBox[{"{", System`RowBox[{"3", ",", "3", 
                  ",", "1"}], "}"}]}], "]"}], ",", System`RowBox[
           ...
           {"{", System`RowBox[{System`StyleBox[System`RowBox[
                {"ArrayReshape", "::", "list"}], "MessageName"], ",", 
              System`StyleBox[System`RowBox[{"Part", "::", "partd"}], 
               "MessageName"], ",", System`StyleBox[System`RowBox[
                {"Part", "::", "partd"}], "MessageName"], ",", 
              System`StyleBox[System`RowBox[{"Part", "::", "partd"}], 
               "MessageName"], ",", System`StyleBox[System`RowBox[
                {"General", "::", "stop"}], "MessageName"]}], "}"}], ",", 
          System`RowBox[{"{", "}"}]}], "]"}]}], "]"}]], "Input", 
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {3.681645302346301*^9}]
