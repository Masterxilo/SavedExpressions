    ...
    System`RowBox[{System`RowBox[{"{", "gd", "}"}], ",", 
      System`RowBox[{"PTest", "[", System`RowBox[
         {System`RowBox[{System`RowBox[{"(", System`RowBox[{System`RowBox[
                 {"gd", "=", System`RowBox[{"GridDataMakeFromArrays", "[", 
             ...
             {"{", System`RowBox[{System`RowBox[{"GDArrayDepth", "[", "gd", 
                  "]"}], ",", System`RowBox[{"GDLookupList", "[", 
                  System`RowBox[{"gd", ",", System`RowBox[{"{", System`RowBox[
                       {"1", ",", "1", ",", "1"}], "}"}]}], "]"}]}], "}"}]}], 
          ",", System`RowBox[{"{", System`RowBox[{"3", ",", System`RowBox[{
                "{", "1.`", "}"}]}], "}"}], ",", System`RowBox[{"{", "}"}], 
          ",", System`RowBox[{"{", "}"}]}], "]"}]}], "]"}]], "Input", 
 System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {3.6816491595881367*^9}]
