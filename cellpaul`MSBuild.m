...
(x86)\\\\MSBuild\\\\12.0\\\\Bin\\\\msbuild.exe\"", ",", System`RowBox[
        ...
        "\[IndentingNewLine]", System`RowBox[{"RunProcess", "[", 
          System`RowBox[{System`RowBox[{"{", System`RowBox[{"\"C:\\\\Program \
Files (x86)\\\\MSBuild\\\\12.0\\\\Bin\\\\msbuild.exe\"", ",", System`RowBox[
                 {"FindFile", "@", "sln"}]}], "}"}], "~", "Join", "~", 
            "extra"}], "]"}]}]}], "\[IndentingNewLine]", "]"}]], "Input", 
 System`CellChangeTimes -> {{3.6810315425304565*^9, 3.681031629670125*^9}, 
  ...
  {3.6810574700955496*^9, 3.6810574859842663*^9}, {3.6810627862405376*^9, 
  3.6810627892555037*^9}}, System`CellTags -> 
