...
(x86)\\\\MSBuild\\\\12.0\\\\Bin\\\\msbuild.exe\"", ",", System`RowBox[
 ...
 System`CellAutoOverwrite -> System`True, System`CellChangeTimes -> 
  {{3.6810315425304565*^9, 3.681031629670125*^9}, {3.681031797799365*^9, 
   ...
   3.6810574859842663*^9}, {3.6810627862405376*^9, 3.6810627892555037*^9}, 
   {3.681086864435445*^9, 3.681086872466464*^9}, {3.6810869609989386*^9, 
   3.681086978466728*^9}, 3.6811983896175513*^9, 3.6815068328506546*^9}, 
 System`CellTags -> "depersistedCell7765c663-9110-40b0-858d-9266c2c71fa9"]
