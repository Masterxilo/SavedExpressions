...
VerificationTest items from the current testing notebook", 
  System`SequenceCases[System`NotebookRead[System`Cells[]], 
   {Global`i:System`Cell[___, "VerificationTest", ___], 
     ...
     Global`p:System`Cell[___, "TestOptions", ___]:Global`EmptyListInputCell[
       ]} :> System`With[{Global`input = Global`FlattenNull[
        System`ToExpression[System`First[Global`i], System`StandardForm, 
         System`HoldComplete]], Global`output = Global`FlattenNull[
        System`ToExpression[System`First[Global`o], System`StandardForm, 
         System`HoldComplete]], Global`messages = Global`FlattenNull[
        System`ToExpression[System`First[Global`m], System`StandardForm, 
         System`HoldComplete]], Global`options = Global`FlattenNull[
        System`ToExpression[System`First[Global`p], System`StandardForm, 
