System`HoldComplete[Global`NeedsDefined[
   ...
   Global`ps]; (PackageDeveloper`RedefinePublicFunction[
    ...
    RIFunction`RIFunctionEvaluateNameless[System`PatternSequence[], 
      Scene2D`f:RIFunction`RIFunction[Global`ExpressionList, 
        Scene2D`expr_System`List, Scene2D`vars_System`List, ___], 
      (Global`vals_)?numerics`NumericVectorQ] /; 
     System`Length[Global`vals] == System`Length[Scene2D`vars], "", 
    System`Module[{}, System`Null; Scene2D`expr /. 
       System`Thread[Scene2D`vars -> Global`vals]]]; 
   ...
   PackageDeveloper`DefinePublicFunction[
    ...
    RIFunction`RIFunctionEvaluateNameless[System`PatternSequence[], 
      ...
      (Global`vals_)?numerics`NumericVectorQ] /; 
     System`Length[Global`vals] == System`Length[Global`ps]*
