        ...
        ",", System`RowBox[{System`RowBox[{"{", "\[IndentingNewLine]", 
            System`RowBox[{System`RowBox[{"canonicalGd", "=", System`RowBox[
                 {"GDDataSubset", "[", System`RowBox[{"gd", ",", 
                    System`RowBox[{"Scene3D`Scene3DRequiredData", "~", 
          ...
          System`RowBox[{"Scene3D", "[", "f", "]"}]}]}], 
      "\[IndentingNewLine]", "]"}], ";"}]], "Input", 
 System`CellChangeTimes -> {{3.6802739209802947*^9, 3.680273954876588*^9}, 
   {3.680279070120661*^9, 3.6802791224689693*^9}, {3.6803785336750107*^9, 
   3.6803785520949955*^9}, 3.6809819456744986*^9, {3.680982334119852*^9, 
   3.680982349459982*^9}, {3.680982419766919*^9, 3.680982440189762*^9}, 
   {3.68098260498135*^9, 3.680982605684554*^9}, {3.6809826361147585*^9, 
   3.680982640179939*^9}, {3.680982679878947*^9, 3.6809826819103003*^9}}, 
