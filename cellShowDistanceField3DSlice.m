System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"ShowDistanceField3DSlice", ",", "\[IndentingNewLine]", 
      "\[IndentingNewLine]", System`RowBox[
       {System`RowBox[{"ShowDistanceField3DSlice", "//", 
          "UnprotectClearAll"}], ";", "\[IndentingNewLine]", 
        "\[IndentingNewLine]", System`RowBox[
         {System`RowBox[{"ShowDistanceField3DSlice", "::", "usage"}], "=", "\
\"Uses ShowDistanceField to interactively show only one slice at a time (in \
any direction) through a 3d volume\""}], ";", "\[IndentingNewLine]", 
        "\[IndentingNewLine]", System`RowBox[
   ...
   3.6814916012590547*^9}, {3.6814935072139745*^9, 3.6814935115889935*^9}, 
   {3.6814974335666094*^9, 3.681497447143264*^9}, 3.681641746646394*^9, 
   {3.6816425399457426*^9, 3.6816425525384636*^9}}]
