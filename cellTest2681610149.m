        ...
        System`RowBox[{"{", System`RowBox[{System`RowBox[
            ...
            System`RowBox[{"RVVAsRules", "[", System`RowBox[{"xx", "=", 
              ...
              System`RowBox[{"RIFunctionEvaluate", "[", System`RowBox[
                 {"f", ",", "xx"}], "]"}], "]"}], ",", System`RowBox[
             {"RIFunctionEvaluateNameless", "[", System`RowBox[{"f", ",", 
                System`RowBox[{"{", "0.25`", "}"}]}], "]"}], ",", 
            System`RowBox[{"RIFunctionExpressionList", "[", System`RowBox[{
                "fdx", "=", System`RowBox[{"RIFunctionMakeDerivative", "[", 
                  System`RowBox[{"f", ",", "x"}], "]"}]}], "]"}], ",", 
            System`RowBox[{"RVVAsRules", "[", System`RowBox[{
                "RIFunctionEvaluate", "[", System`RowBox[{"fdx", ",", 
                  System`RowBox[{"RVarvalMake", "[", System`RowBox[
                     {"{", System`RowBox[{"x", "\[Rule]", "0.25`"}], "}"}], 
                    "]"}]}], "]"}], "]"}], ",", System`RowBox[
             {"RIFunctionExpressionList", "[", System`RowBox[{"fdx", "=", 
                System`RowBox[{"RIFunctionMakeDerivativeIndexed", "[", 
                  System`RowBox[{"f", ",", "1"}], "]"}]}], "]"}], ",", 
            System`RowBox[{"RVVAsRules", "[", System`RowBox[{
                "RIFunctionEvaluate", "[", System`RowBox[{"fdx", ",", 
                  System`RowBox[{"RVarvalMake", "[", System`RowBox[
                    ...
                    "]"}]}], "]"}], "]"}]}], "}"}]}], ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[
           {"{", System`RowBox[{"x", ",", System`RowBox[{"1", "-", "x"}]}], 
            "}"}], ",", System`RowBox[{"{", "x", "}"}], ",", 
          System`RowBox[{"{", System`RowBox[{"x", "\[Rule]", "0.25`"}], 
            "}"}], ",", System`RowBox[{"{", System`RowBox[
             {System`RowBox[{System`RowBox[{"{", "1", "}"}], "\[Rule]", 
                "0.25`"}], ",", System`RowBox[{System`RowBox[{"{", "2", 
                  "}"}], "\[Rule]", "0.75`"}]}], "}"}], ",", 
          System`RowBox[{"{", System`RowBox[{"0.25`", ",", "0.75`"}], "}"}], 
          ",", System`RowBox[{"{", System`RowBox[{"1.`", ",", 
              System`RowBox[{"-", "1.`"}]}], "}"}], ",", 
          System`RowBox[{"{", System`RowBox[{System`RowBox[{System`RowBox[
                 {"{", "1", "}"}], "\[Rule]", "1.`"}], ",", System`RowBox[{
