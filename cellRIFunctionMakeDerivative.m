System`Cell[System`BoxData[System`RowBox[{"Persist", "[", 
    System`RowBox[{"RIFunctionMakeDerivative", ",", "\[IndentingNewLine]", 
      ...
      System`RowBox[{"(*", " ", System`RowBox[
         {System`RowBox[{"TODO", " ", "this", " ", "might", " ", "not", " ", 
            ...
            " ", "particular"}], ",", " ", System`RowBox[{"this", " ", 
            "does", " ", "nto", " ", "yet", " ", "support", " ", "named", 
      ...
      System`RowBox[{System`RowBox[{"RedefinePublicFunction", "[", "\n", 
          ...
          " ", System`RowBox[{"(*", " ", System`RowBox[
             {System`RowBox[{"TODO", " ", "instead", " ", "of", " ", 
                "creating", " ", "an", " ", "FMMakeListDomainNames", " ", 
                "here", " ", "and", " ", "removing", " ", "it", " ", 
                "later"}], ",", " ", System`RowBox[{System`RowBox[
                 {"don", "'"}], "t", " ", "create", " ", "it"}]}], " ", 
            "*)"}], "\n", "]"}], ";", "\n", "\[IndentingNewLine]", 
        System`RowBox[{"DefinePublicFunction", "[", "\[IndentingNewLine]", 
          System`RowBox[{System`RowBox[{"RIFunctionMakeDerivative", "[", 
              System`RowBox[{System`RowBox[{"RIFunction", "[", System`RowBox[
                   {"Compiled", ",", "rif_RIFunction", ",", "___"}], "]"}], 
                ",", " ", "x_"}], "]"}], ",", "\"\"", ",", 
            System`RowBox[{"RIFunctionMakeDerivative", "[", System`RowBox[{
                "rif", ",", "x"}], "]"}]}], "\[IndentingNewLine]", "]"}], 
        ";", "\[IndentingNewLine]", "\n", System`RowBox[
         {"DefinePublicFunction", "[", "\n", System`RowBox[
           {System`RowBox[{System`RowBox[{"RIFunctionMakeDerivative", "[", 
                System`RowBox[{System`RowBox[{"f", ":", System`RowBox[
                     {"RIFunction", "[", System`RowBox[{"Constant", ",", " ", 
                        "inputs_List", ",", " ", "output_RVarval"}], "]"}]}], 
                  ",", " ", "x_"}], "]"}], " ", "/;", " ", System`RowBox[{
                System`RowBox[{"RIFunctionArguments", "@", "f"}], "~", 
                "Contains", "~", "x"}]}], "\n", "\n", "  ", ",", 
            "\"df\n--\ndx\n\nd_x f\"", "\n", "\n", "    ", ",", 
            System`RowBox[{System`RowBox[{"{", System`RowBox[{"outputzeros", 
                  " ", "=", " ", System`RowBox[{"RVarvalMakeConstant", "[", 
                    System`RowBox[{System`RowBox[{"RVVVariables", "@", 
                        "output"}], ",", " ", "0."}], "]"}]}], "}"}], "~", 
              "With", "~", System`RowBox[{"RIFunction", "[", System`RowBox[
                 {"Constant", ",", " ", "inputs", ",", " ", "outputzeros"}], 
                "]"}]}]}], "\n", "  ", "]"}], ";", "\n", 
        System`RowBox[{"(*", "\n", "\n", "*)"}], "\n", "\n", 
        System`RowBox[{"DefinePublicFunction", "[", "\n", 
          System`RowBox[{System`RowBox[{System`RowBox[{
              ...
              System`RowBox[{System`RowBox[{"RIFunctionArguments", "@", 
                  "f"}], "~", "Contains", "~", "x"}]}], "\n", "  ", ",", 
            "\"\"", ",", "\n", "    ", System`RowBox[{System`RowBox[{"{", 
                System`RowBox[{"dcomponents", " ", "=", " ", System`RowBox[
                   {System`RowBox[{System`RowBox[{"RIFunctionMakeDerivative", 
                        "[", System`RowBox[{"#", ",", "x"}], "]"}], "&"}], 
                    "~", "FMMapValues", "~", "components"}]}], "}"}], " ", 
              "~", "With", "~", " ", System`RowBox[{"RIFunction", "[", 
                System`RowBox[{"Multiple", ",", " ", "dcomponents", ",", " ", 
                  "pairing"}], "]"}]}]}], "\n", "]"}], ";", "\n", 
        System`RowBox[{"(*", " ", System`RowBox[
           {System`RowBox[{System`RowBox[{"f", ":", " ", "B"}], " ", "->", 
              " ", "A"}], ",", " ", System`RowBox[{"where", " ", "A", " ", 
              "are", " ", "selected", " ", "from", " ", "B", " ", 
              "according", " ", "to", " ", "saIndex", " ", "which", " ", 
              "has", " ", "no", " ", "repeated", " ", System`RowBox[{
                "values", ".", "\n", "\n", "Thus"}], " ", "the", " ", 
              "derivative", " ", "is", " ", "a", " ", "constant", " ", 
              "vector", " ", "of", " ", "length", " ", "A", " ", "with", " ", 
              "a", " ", "1.", " ", "only", " ", "for", " ", "x"}]}], "\n", 
          "*)"}], "\n", "\n", System`RowBox[{"DefinePublicFunction", "[", 
          "\n", System`RowBox[{System`RowBox[{System`RowBox[{
                "RIFunctionMakeDerivative", "[", System`RowBox[
            ...
            "\"\"", ",", "\n", System`RowBox[{"With", "[", System`RowBox[{
                System`RowBox[{"{", System`RowBox[{"indexOfXInB", " ", "=", 
                  ...
                  "RIFunctionMakeConstant", "~", System`RowBox[
                   {"RVarvalMake", "[", System`RowBox[{"a", ",", "\n", 
                      "      ", System`RowBox[{"SparseArray", "[", "\n", 
                        "        ", System`RowBox[{"Map", "[", System`RowBox[
 ...
 "Input", System`CellChangeTimes -> {{3.680943087764499*^9, 
   3.6809431074400516*^9}, 3.6809442483756785*^9, {3.6809674986393175*^9, 
   3.6809675609875436*^9}, 3.6816553417369833*^9, 3.6816558763854313*^9}, 
