System`Cell[System`BoxData[System`RowBox[
   {System`RowBox[{"PRedefinePublicFunction", "[", "\n", 
      System`RowBox[{System`RowBox[{"GDCoordinateBoundingBox", "[", 
          "g_GridData", "]"}], "\n", "  ", ",", 
        "\"alternate coordinate bounds\"", "\n", "  ", ",", 
        System`RowBox[{"CoordinateBoundingBox", "@", System`RowBox[
           {"GDDomain", "@", "g"}]}]}], "\n", "\n", "  ", "]"}], ";"}]], 
 "Code", System`GeneratedCell -> System`True, System`CellAutoOverwrite -> 
  System`True, System`CellChangeTimes -> {{3.6815682608556404*^9, 
   ...
   3.68157351190701*^9}, {3.681573561428832*^9, 3.6815735722943983*^9}, 
   3.6816352939918985*^9}]
