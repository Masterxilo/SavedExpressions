System`HoldComplete[PackageDeveloper`RedefinePublicFunction[{System`HoldAll}, 
  paul`WhichDownValueRule[Global`d:(Global`f_System`Symbol)[Global`args___]], 
  "Like WhichDownValue but also returns the right hand side of the DownValue \
that applies if any.\nArguments will only be evaluated if the Head's \
arguments say they should. Unless there are UpValues/SubValues involved, this \
gives the next step of evaluation.", System`Module[
   {Global`dummyHead, Global`evaluatedArguments, Global`x}, 
   System`SetAttributes[Global`dummyHead, System`Attributes[Global`f]]; 
    ...
    System`With[{Global`hfx = Global`evaluatedArguments /. 
      ...
      System`SelectFirst[(System`Hold /@ #1 & ) /@ System`DownValues[
       ...
       System`Missing["NotFound", {paul`WhichDownValueRule, 
