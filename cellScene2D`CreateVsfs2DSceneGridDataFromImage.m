System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"Scene2D`CreateVsfs2DSceneGridDataFromImage", "[", 
        "Global`args___", "]"}], "\[IndentingNewLine]", 
      "\[IndentingNewLine]", ",", "\"transform the result of \
CreateVsfs2DSceneFromImage into a GridData object\"", ",", 
      ...
      System`RowBox[{"With", "[", System`RowBox[
         {System`RowBox[{"{", System`RowBox[{System`RowBox[{"s", "=", 
                System`RowBox[{"Scene2D`CreateVsfs2DSceneFromImage", "[", 
                  "Global`args", "]"}]}], ",", System`RowBox[{"vars", "=", 
  ...
  {{3.6805635175748672*^9, 3.6805635864137363*^9}, {3.68056362122238*^9, 
   ...
   3.6808941730940456*^9}, {3.6815880090609646*^9, 3.681588022020142*^9}}, 
