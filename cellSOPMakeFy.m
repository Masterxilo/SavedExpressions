System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"SOPMakeFy", "[", "p_SparseOptimizationProblem", "]"}], 
      "\[IndentingNewLine]", "\[IndentingNewLine]", ",", "\"F(x) is the \
...
function that emulates F(y)\"", ",", "\[IndentingNewLine]", 
  ...
  {3.6809520968193655*^9, 3.6809521047638483*^9}, {3.6816499125160866*^9, 
  3.68164992219215*^9}}, System`CellTags -> 
  "depersistedCellc47de2fe-a355-4cd4-b826-f5f12847c9a0"]
