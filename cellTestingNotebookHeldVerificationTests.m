System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"TestingNotebookHeldVerificationTests", "[", "]"}], 
      "\[IndentingNewLine]", "\[IndentingNewLine]", ",", "\"make a list of \
Hold VerificationTest items from the current testing notebook\"", 
                ...
                "\[IndentingNewLine]", System`RowBox[{System`RowBox[
                   {"(", System`RowBox[{"p", ":", System`RowBox[{"Cell", "[", 
                        System`RowBox[{"___", ",", "\"TestOptions\"", ",", 
                          "___"}], "]"}]}], ")"}], "~", "Optional", "~", 
                  System`RowBox[{"EmptyListInputCell", "[", "]"}]}]}], 
              "\[IndentingNewLine]", "\[IndentingNewLine]", "}"}], 
  ...
  {3.681645622053911*^9, 3.681645627031107*^9}}, 
