System`Cell[System`BoxData[System`RowBox[{"PRedefinePublicFunction", "[", 
    "\[IndentingNewLine]", System`RowBox[
     {System`RowBox[{"paul`PartitionRangeApproximately2DByLength", "[", 
        "\[IndentingNewLine]", System`RowBox[
...
coordinates.\n\"", ",", "\[IndentingNewLine]", "\[IndentingNewLine]", 
         ...
         {System`RowBox[{"{", System`RowBox[{"r1", ",", "r2"}], "}"}], ",", 
          "\[IndentingNewLine]", System`RowBox[
           {System`RowBox[{"r1", "=", System`RowBox[{
                "paul`PartitionRangeApproximatelyByLength", "[", 
                System`RowBox[{"xmin", ",", "xmax", ",", "lengthx"}], 
                "]"}]}], ";", "\[IndentingNewLine]", System`RowBox[
             {"r2", "=", System`RowBox[{
                "paul`PartitionRangeApproximatelyByLength", "[", 
                System`RowBox[{"ymin", ",", "ymax", ",", "lengthy"}], 
                "]"}]}], ";", "\[IndentingNewLine]", System`RowBox[
             {"CoordinateBoundsArray", "/@", System`RowBox[{"Tuples", "@", 
                System`RowBox[{"{", System`RowBox[{"r1", ",", "r2"}], 
                  "}"}]}]}]}]}], "\[IndentingNewLine]", "]"}], 
      "\[IndentingNewLine]", "\[IndentingNewLine]", ",", 
      System`RowBox[{"{", System`RowBox[{System`RowBox[
 ...
 System`CellChangeTimes -> {3.6811384689808364*^9, {3.681138532011056*^9, 
   3.6811385555415735*^9}, {3.6811387966471586*^9, 3.6811389073951902*^9}, 
   {3.681587479834282*^9, 3.681587486377451*^9}}, 
