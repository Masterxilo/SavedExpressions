System`HoldComplete[Global`NeedsDefined[
   ...
   SceneX`Scene2DEnergyData, Scene2D`Scene2DEnergyY, 
...
d of this Scene2D. Depends on SparseOptimizationProblem`", 
   System`With[{SOP`sop = SOP`SparseOptimizationProblemMake[
       Scene2D`Scene2DEnergyf[Global`s], Scene2D`Scene2DEnergySelect[
        Global`s], Scene2D`Scene2DEnergyP[Global`s], SceneX`Scene2DEnergyData[
        Global`s, SceneX`weights], Scene2D`Scene2DEnergyY[Global`s]]}, 
    SOP`sop], _SOP`SparseOptimizationProblem]]
